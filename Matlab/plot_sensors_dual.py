...
def main():
    ...
    print("\n📋 IMPORTANTE:")
    print("   • Gráficos mostram dados originais dos sensores")
    print("   • Comando 's' salva arquivos CSV com dados originais")
