...
vet_error_ETS_c = readmatrix('MTS_NLLS_f7_FPU.csv');
fuck = readmatrix('MTS_ETS_f7_FPU.csv');
vet_error_NLLS_c = readmatrix('MTS_NLLS_f7_ST_primeiro.csv');
...
for i = 1:1:exe
    ...
    passos_NLLS_ST = passos_NLLS_ST + vet_error_NLLS_c(11,i);
    if i < 781
        passos_NLLS_full = passos_NLLS_full + fuck(11,i);
    else
        passos_NLLS_full = passos_NLLS_full + vet_error_ETS_c(11,i);
    end
end

exe_time_ETS = exe_time_ETS/3000;
exe_time_NLLS = exe_time_NLLS/3000;
passos_NLLS_full = passos_NLLS_full/3000;
passos_NLLS_ST = passos_NLLS_ST/3000;
...
disp("Tempo de execução do NLLS usando série de Taylor:")
disp(exe_time_NLLS)

disp("Passos do NLLS completo:")
disp(passos_NLLS_full)

disp("Passos do NLLS Série de Taylor:")
disp(passos_NLLS_ST)
