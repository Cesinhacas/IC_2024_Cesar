...
static void initialize_c8_modelo_FK_trial_2_testes
  (SFc8_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void initialize_params_c8_modelo_FK_trial_2_testes
  (SFc8_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void enable_c8_modelo_FK_trial_2_testes
  (SFc8_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void disable_c8_modelo_FK_trial_2_testes
  (SFc8_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_modelo_FK_trial_2_testes
  (SFc8_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_modelo_FK_trial_2_testes
  (SFc8_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void set_sim_state_c8_modelo_FK_trial_2_testes
  (SFc8_modelo_FK_trial_2_testesInstanceStruct *chartInstance, const mxArray
   *c8_st);
static void finalize_c8_modelo_FK_trial_2_testes
  (SFc8_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void sf_c8_modelo_FK_trial_2_testes
  (SFc8_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void c8_chartstep_c8_modelo_FK_trial_2_testes
  (SFc8_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void initSimStructsc8_modelo_FK_trial_2_testes
  (SFc8_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void registerMessagesc8_modelo_FK_trial_2_testes
  (SFc8_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static void c8_emlrt_marshallIn(SFc8_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c8_u_recuperado, const char_T *c8_identifier,
  real_T c8_y[3]);
static void c8_b_emlrt_marshallIn(SFc8_modelo_FK_trial_2_testesInstanceStruct
...
static const mxArray *c8_b_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static real_T c8_c_emlrt_marshallIn(SFc8_modelo_FK_trial_2_testesInstanceStruct *
  chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_c_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_d_emlrt_marshallIn(SFc8_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  real_T c8_y[9]);
static void c8_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static void c8_info_helper(c8_ResolvedFunctionInfo c8_info[45]);
static void c8_diag(SFc8_modelo_FK_trial_2_testesInstanceStruct *chartInstance,
                    real_T c8_v[3], real_T c8_d[9]);
static void c8_inv(SFc8_modelo_FK_trial_2_testesInstanceStruct *chartInstance,
                   real_T c8_x[9], real_T c8_y[9]);
static void c8_inv3x3(SFc8_modelo_FK_trial_2_testesInstanceStruct *chartInstance,
                      real_T c8_x[9], real_T c8_y[9]);
static real_T c8_norm(SFc8_modelo_FK_trial_2_testesInstanceStruct *chartInstance,
                      real_T c8_x[9]);
static void c8_eml_warning(SFc8_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance);
static void c8_b_eml_warning(SFc8_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, char_T c8_varargin_2[14]);
static void c8_eml_scalar_eg(SFc8_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance);
static void c8_b_eml_scalar_eg(SFc8_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance);
static void c8_e_emlrt_marshallIn(SFc8_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c8_sprintf, const char_T *c8_identifier, char_T
  c8_y[14]);
static void c8_f_emlrt_marshallIn(SFc8_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  char_T c8_y[14]);
static const mxArray *c8_d_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_g_emlrt_marshallIn(SFc8_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static uint8_T c8_h_emlrt_marshallIn(SFc8_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c8_b_is_active_c8_modelo_FK_trial_2_testes,
  const char_T *c8_identifier);
static uint8_T c8_i_emlrt_marshallIn(SFc8_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void init_dsm_address_info(SFc8_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance);
  ...
  (SFc8_modelo_FK_trial_2_testesInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_modelo_FK_trial_2_testes = 0U;
}
  ...
  (SFc8_modelo_FK_trial_2_testesInstanceStruct *chartInstance)
{
  ...
  c8_hoistedGlobal = chartInstance->c8_is_active_c8_modelo_FK_trial_2_testes;
   ...
   *c8_st)
{
  ...
  chartInstance->c8_is_active_c8_modelo_FK_trial_2_testes =
    c8_h_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 1)),
    "is_active_c8_modelo_FK_trial_2_testes");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_modelo_FK_trial_2_testes(chartInstance);
  ...
  (SFc8_modelo_FK_trial_2_testesInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_sfEvent = CALL_EVENT;
  c8_chartstep_c8_modelo_FK_trial_2_testes(chartInstance);
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_modelo_FK_trial_2_testesInstanceStruct *chartInstance;
  chartInstance = (SFc8_modelo_FK_trial_2_testesInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c8_modelo_FK_trial_2_testes_get_eml_resolved_functions_info
  (void)
{
  ...
  const char_T *c8_identifier)
{
  ...
  c8_y = c8_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_modelo_FK_trial_2_testes), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_modelo_FK_trial_2_testes);
  return c8_y;
}
...
void sf_c8_modelo_FK_trial_2_testes_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_modelo_FK_trial_2_testes_get_autoinheritance_info(void)
{
...
mxArray *sf_c8_modelo_FK_trial_2_testes_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c8_modelo_FK_trial_2_testes(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"u_recuperado\",},{M[8],M[0],T\"is_active_c8_modelo_FK_trial_2_testes\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_modelo_FK_trial_2_testes_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c8_modelo_FK_trial_2_testes(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_modelo_FK_trial_2_testesInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_modelo_FK_trial_2_testes
    ((SFc8_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
  initialize_c8_modelo_FK_trial_2_testes
    ((SFc8_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c8_modelo_FK_trial_2_testes(void *chartInstanceVar)
{
  enable_c8_modelo_FK_trial_2_testes
    ((SFc8_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c8_modelo_FK_trial_2_testes(void *chartInstanceVar)
{
  disable_c8_modelo_FK_trial_2_testes
    ((SFc8_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c8_modelo_FK_trial_2_testes(void *chartInstanceVar)
{
  sf_c8_modelo_FK_trial_2_testes((SFc8_modelo_FK_trial_2_testesInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_modelo_FK_trial_2_testes
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_modelo_FK_trial_2_testes
    ((SFc8_modelo_FK_trial_2_testesInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_modelo_FK_trial_2_testes();/* state var info */
...
extern void sf_internal_set_sim_state_c8_modelo_FK_trial_2_testes(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c8_modelo_FK_trial_2_testes
    ((SFc8_modelo_FK_trial_2_testesInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_modelo_FK_trial_2_testes
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c8_modelo_FK_trial_2_testes(S);
}

static void sf_opaque_set_sim_state_c8_modelo_FK_trial_2_testes(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c8_modelo_FK_trial_2_testes(S, st);
}

static void sf_opaque_terminate_c8_modelo_FK_trial_2_testes(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_modelo_FK_trial_2_testesInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c8_modelo_FK_trial_2_testes
      ((SFc8_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc8_modelo_FK_trial_2_testes
    ((SFc8_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_modelo_FK_trial_2_testes(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c8_modelo_FK_trial_2_testes
      ((SFc8_modelo_FK_trial_2_testesInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c8_modelo_FK_trial_2_testes(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c8_modelo_FK_trial_2_testes(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_modelo_FK_trial_2_testes(SimStruct *S)
{
  SFc8_modelo_FK_trial_2_testesInstanceStruct *chartInstance;
  chartInstance = (SFc8_modelo_FK_trial_2_testesInstanceStruct *)utMalloc(sizeof
    (SFc8_modelo_FK_trial_2_testesInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_modelo_FK_trial_2_testesInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c8_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c8_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_modelo_FK_trial_2_testes;
...
void c8_modelo_FK_trial_2_testes_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_modelo_FK_trial_2_testes(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_modelo_FK_trial_2_testes(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_modelo_FK_trial_2_testes(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_modelo_FK_trial_2_testes_method_dispatcher.\n"
