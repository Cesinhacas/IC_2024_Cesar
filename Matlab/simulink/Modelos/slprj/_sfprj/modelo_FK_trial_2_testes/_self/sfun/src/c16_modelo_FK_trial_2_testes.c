...
static void initialize_c16_modelo_FK_trial_2_testes
  (SFc16_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void initialize_params_c16_modelo_FK_trial_2_testes
  (SFc16_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void enable_c16_modelo_FK_trial_2_testes
  (SFc16_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void disable_c16_modelo_FK_trial_2_testes
  (SFc16_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void c16_update_debugger_state_c16_modelo_FK_trial_2_testes
  (SFc16_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c16_modelo_FK_trial_2_testes
  (SFc16_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void set_sim_state_c16_modelo_FK_trial_2_testes
  (SFc16_modelo_FK_trial_2_testesInstanceStruct *chartInstance, const mxArray
   *c16_st);
static void finalize_c16_modelo_FK_trial_2_testes
  (SFc16_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void sf_c16_modelo_FK_trial_2_testes
  (SFc16_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void c16_chartstep_c16_modelo_FK_trial_2_testes
  (SFc16_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void initSimStructsc16_modelo_FK_trial_2_testes
  (SFc16_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void registerMessagesc16_modelo_FK_trial_2_testes
  (SFc16_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
...
static const mxArray *c16_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static void c16_emlrt_marshallIn(SFc16_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c16_qr, const char_T *c16_identifier, real_T
  c16_y[4]);
static void c16_b_emlrt_marshallIn(SFc16_modelo_FK_trial_2_testesInstanceStruct *
...
static const mxArray *c16_d_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static void c16_d_emlrt_marshallIn(SFc16_modelo_FK_trial_2_testesInstanceStruct *
  chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId,
  real_T c16_y[3]);
...
static void c16_realmin(SFc16_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance);
static void c16_eml_error(SFc16_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance);
static const mxArray *c16_e_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static int32_T c16_e_emlrt_marshallIn
  (SFc16_modelo_FK_trial_2_testesInstanceStruct *chartInstance, const mxArray
   *c16_u, const emlrtMsgIdentifier *c16_parentId);
...
static uint8_T c16_f_emlrt_marshallIn
  (SFc16_modelo_FK_trial_2_testesInstanceStruct *chartInstance, const mxArray
   *c16_b_is_active_c16_modelo_FK_trial_2_testes, const char_T *c16_identifier);
static uint8_T c16_g_emlrt_marshallIn
  (SFc16_modelo_FK_trial_2_testesInstanceStruct *chartInstance, const mxArray
   *c16_u, const emlrtMsgIdentifier *c16_parentId);
static void init_dsm_address_info(SFc16_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance);
  ...
  (SFc16_modelo_FK_trial_2_testesInstanceStruct *chartInstance)
{
  ...
  chartInstance->c16_is_active_c16_modelo_FK_trial_2_testes = 0U;
}
  ...
  (SFc16_modelo_FK_trial_2_testesInstanceStruct *chartInstance)
{
  ...
  c16_hoistedGlobal = chartInstance->c16_is_active_c16_modelo_FK_trial_2_testes;
   ...
   *c16_st)
{
  ...
  chartInstance->c16_is_active_c16_modelo_FK_trial_2_testes =
    c16_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c16_u, 1)),
    "is_active_c16_modelo_FK_trial_2_testes");
  sf_mex_destroy(&c16_u);
  c16_update_debugger_state_c16_modelo_FK_trial_2_testes(chartInstance);
  ...
  (SFc16_modelo_FK_trial_2_testesInstanceStruct *chartInstance)
{
  ...
  chartInstance->c16_sfEvent = CALL_EVENT;
  c16_chartstep_c16_modelo_FK_trial_2_testes(chartInstance);
  ...
  *c16_inData)
{
  ...
  const mxArray *c16_y = NULL;
  SFc16_modelo_FK_trial_2_testesInstanceStruct *chartInstance;
  chartInstance = (SFc16_modelo_FK_trial_2_testesInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c16_modelo_FK_trial_2_testes_get_eml_resolved_functions_info
  (void)
{
   ...
   *c16_b_is_active_c16_modelo_FK_trial_2_testes, const char_T *c16_identifier)
{
  ...
  c16_y = c16_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c16_b_is_active_c16_modelo_FK_trial_2_testes), &c16_thisId);
  sf_mex_destroy(&c16_b_is_active_c16_modelo_FK_trial_2_testes);
  return c16_y;
}
...
void sf_c16_modelo_FK_trial_2_testes_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c16_modelo_FK_trial_2_testes_get_autoinheritance_info(void)
{
...
mxArray *sf_c16_modelo_FK_trial_2_testes_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c16_modelo_FK_trial_2_testes(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"qr\",},{M[8],M[0],T\"is_active_c16_modelo_FK_trial_2_testes\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c16_modelo_FK_trial_2_testes_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c16_modelo_FK_trial_2_testes(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc16_modelo_FK_trial_2_testesInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c16_modelo_FK_trial_2_testes
    ((SFc16_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
  initialize_c16_modelo_FK_trial_2_testes
    ((SFc16_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c16_modelo_FK_trial_2_testes(void *chartInstanceVar)
{
  enable_c16_modelo_FK_trial_2_testes
    ((SFc16_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c16_modelo_FK_trial_2_testes(void
  *chartInstanceVar)
{
  disable_c16_modelo_FK_trial_2_testes
    ((SFc16_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c16_modelo_FK_trial_2_testes(void
  *chartInstanceVar)
{
  sf_c16_modelo_FK_trial_2_testes((SFc16_modelo_FK_trial_2_testesInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c16_modelo_FK_trial_2_testes
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c16_modelo_FK_trial_2_testes
    ((SFc16_modelo_FK_trial_2_testesInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c16_modelo_FK_trial_2_testes();/* state var info */
...
extern void sf_internal_set_sim_state_c16_modelo_FK_trial_2_testes(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c16_modelo_FK_trial_2_testes
    ((SFc16_modelo_FK_trial_2_testesInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c16_modelo_FK_trial_2_testes
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c16_modelo_FK_trial_2_testes(S);
}

static void sf_opaque_set_sim_state_c16_modelo_FK_trial_2_testes(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c16_modelo_FK_trial_2_testes(S, st);
}

static void sf_opaque_terminate_c16_modelo_FK_trial_2_testes(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc16_modelo_FK_trial_2_testesInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c16_modelo_FK_trial_2_testes
      ((SFc16_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc16_modelo_FK_trial_2_testes
    ((SFc16_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c16_modelo_FK_trial_2_testes(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c16_modelo_FK_trial_2_testes
      ((SFc16_modelo_FK_trial_2_testesInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c16_modelo_FK_trial_2_testes(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c16_modelo_FK_trial_2_testes(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c16_modelo_FK_trial_2_testes(SimStruct *S)
{
  SFc16_modelo_FK_trial_2_testesInstanceStruct *chartInstance;
  chartInstance = (SFc16_modelo_FK_trial_2_testesInstanceStruct *)utMalloc
    (sizeof(SFc16_modelo_FK_trial_2_testesInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc16_modelo_FK_trial_2_testesInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c16_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c16_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c16_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c16_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c16_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c16_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c16_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c16_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c16_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.mdlStart = mdlStart_c16_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c16_modelo_FK_trial_2_testes;
...
void c16_modelo_FK_trial_2_testes_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c16_modelo_FK_trial_2_testes(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c16_modelo_FK_trial_2_testes(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c16_modelo_FK_trial_2_testes(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c16_modelo_FK_trial_2_testes_method_dispatcher.\n"
