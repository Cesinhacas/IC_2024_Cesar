...
static void initialize_c5_modelo_FK_trial_2_testes
  (SFc5_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void initialize_params_c5_modelo_FK_trial_2_testes
  (SFc5_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void enable_c5_modelo_FK_trial_2_testes
  (SFc5_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void disable_c5_modelo_FK_trial_2_testes
  (SFc5_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_modelo_FK_trial_2_testes
  (SFc5_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_modelo_FK_trial_2_testes
  (SFc5_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void set_sim_state_c5_modelo_FK_trial_2_testes
  (SFc5_modelo_FK_trial_2_testesInstanceStruct *chartInstance, const mxArray
   *c5_st);
static void finalize_c5_modelo_FK_trial_2_testes
  (SFc5_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void sf_c5_modelo_FK_trial_2_testes
  (SFc5_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void c5_chartstep_c5_modelo_FK_trial_2_testes
  (SFc5_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void initSimStructsc5_modelo_FK_trial_2_testes
  (SFc5_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void registerMessagesc5_modelo_FK_trial_2_testes
  (SFc5_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static void c5_emlrt_marshallIn(SFc5_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c5_ur, const char_T *c5_identifier, real_T
  c5_y[3]);
static void c5_b_emlrt_marshallIn(SFc5_modelo_FK_trial_2_testesInstanceStruct
...
static const mxArray *c5_b_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static real_T c5_c_emlrt_marshallIn(SFc5_modelo_FK_trial_2_testesInstanceStruct *
  chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_c_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static void c5_d_emlrt_marshallIn(SFc5_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId,
  real_T c5_y[9]);
static void c5_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static void c5_info_helper(c5_ResolvedFunctionInfo c5_info[64]);
static void c5_diag(SFc5_modelo_FK_trial_2_testesInstanceStruct *chartInstance,
                    real_T c5_v[3], real_T c5_d[9]);
static void c5_eml_scalar_eg(SFc5_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance);
static void c5_b_eml_scalar_eg(SFc5_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance);
static void c5_randn(SFc5_modelo_FK_trial_2_testesInstanceStruct *chartInstance,
                     real_T c5_r[3]);
static void c5_eml_rand_mcg16807(SFc5_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, uint32_T c5_e_state, uint32_T *c5_f_state, real_T *c5_r);
static void c5_genrandu(SFc5_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, uint32_T c5_s, uint32_T *c5_e_state, real_T *c5_r);
static void c5_eml_rand_shr3cong(SFc5_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, uint32_T c5_e_state[2], uint32_T c5_f_state[2], real_T *c5_r);
static real_T c5_abs(SFc5_modelo_FK_trial_2_testesInstanceStruct *chartInstance,
                     real_T c5_x);
static void c5_eml_rand_mt19937ar(SFc5_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, uint32_T c5_e_state[625]);
static void c5_twister_state_vector(SFc5_modelo_FK_trial_2_testesInstanceStruct *
  chartInstance, uint32_T c5_mt[625], real_T c5_seed, uint32_T c5_b_mt[625]);
static void c5_b_eml_rand_mt19937ar(SFc5_modelo_FK_trial_2_testesInstanceStruct *
  chartInstance, uint32_T c5_e_state[625], uint32_T c5_f_state[625], real_T
  *c5_r);
static void c5_assert_valid_state(SFc5_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance);
static void c5_genrand_uint32_vector(SFc5_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, uint32_T c5_mt[625], uint32_T c5_b_mt[625], uint32_T c5_u[2]);
static void c5_b_genrandu(SFc5_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, uint32_T c5_mt[625], uint32_T c5_b_mt[625], real_T *c5_r);
static void c5_eml_error(SFc5_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance);
static const mxArray *c5_d_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_e_emlrt_marshallIn(SFc5_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
...
static uint32_T c5_k_emlrt_marshallIn
  (SFc5_modelo_FK_trial_2_testesInstanceStruct *chartInstance, const mxArray
   *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_l_emlrt_marshallIn(SFc5_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c5_e_state, const char_T *c5_identifier,
  uint32_T c5_y[625]);
static void c5_m_emlrt_marshallIn(SFc5_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId,
  uint32_T c5_y[625]);
static void c5_n_emlrt_marshallIn(SFc5_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c5_e_state, const char_T *c5_identifier,
  uint32_T c5_y[2]);
static void c5_o_emlrt_marshallIn(SFc5_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId,
  uint32_T c5_y[2]);
static void c5_p_emlrt_marshallIn(SFc5_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c5_e_state, const char_T *c5_identifier,
  uint32_T c5_y[2]);
static void c5_q_emlrt_marshallIn(SFc5_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId,
  uint32_T c5_y[2]);
static uint8_T c5_r_emlrt_marshallIn(SFc5_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c5_b_is_active_c5_modelo_FK_trial_2_testes,
  const char_T *c5_identifier);
static uint8_T c5_s_emlrt_marshallIn(SFc5_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static real_T c5_b_eml_rand_mcg16807(SFc5_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, uint32_T *c5_e_state);
static real_T c5_b_eml_rand_shr3cong(SFc5_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, uint32_T c5_e_state[2]);
static void c5_b_twister_state_vector
  (SFc5_modelo_FK_trial_2_testesInstanceStruct *chartInstance, uint32_T c5_mt
   [625], real_T c5_seed);
static real_T c5_c_eml_rand_mt19937ar
  (SFc5_modelo_FK_trial_2_testesInstanceStruct *chartInstance, uint32_T
   c5_e_state[625]);
static void c5_b_genrand_uint32_vector
  (SFc5_modelo_FK_trial_2_testesInstanceStruct *chartInstance, uint32_T c5_mt
   [625], uint32_T c5_u[2]);
static real_T c5_c_genrandu(SFc5_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, uint32_T c5_mt[625]);
static void init_dsm_address_info(SFc5_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance);
  ...
  (SFc5_modelo_FK_trial_2_testesInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_modelo_FK_trial_2_testes = 0U;
}
  ...
  (SFc5_modelo_FK_trial_2_testesInstanceStruct *chartInstance)
{
  ...
  c5_d_hoistedGlobal = chartInstance->c5_is_active_c5_modelo_FK_trial_2_testes;
   ...
   *c5_st)
{
  ...
  chartInstance->c5_is_active_c5_modelo_FK_trial_2_testes =
    c5_r_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 7)),
    "is_active_c5_modelo_FK_trial_2_testes");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_modelo_FK_trial_2_testes(chartInstance);
  ...
  (SFc5_modelo_FK_trial_2_testesInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_sfEvent = CALL_EVENT;
  c5_chartstep_c5_modelo_FK_trial_2_testes(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_modelo_FK_trial_2_testesInstanceStruct *chartInstance;
  chartInstance = (SFc5_modelo_FK_trial_2_testesInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c5_modelo_FK_trial_2_testes_get_eml_resolved_functions_info
  (void)
{
  ...
  const char_T *c5_identifier)
{
  ...
  c5_y = c5_s_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_modelo_FK_trial_2_testes), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_modelo_FK_trial_2_testes);
  return c5_y;
}
...
void sf_c5_modelo_FK_trial_2_testes_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_modelo_FK_trial_2_testes_get_autoinheritance_info(void)
{
...
static void sf_opaque_initialize_c5_modelo_FK_trial_2_testes(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_modelo_FK_trial_2_testesInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c5_modelo_FK_trial_2_testes
    ((SFc5_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
  initialize_c5_modelo_FK_trial_2_testes
    ((SFc5_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_modelo_FK_trial_2_testes(void *chartInstanceVar)
{
  enable_c5_modelo_FK_trial_2_testes
    ((SFc5_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_modelo_FK_trial_2_testes(void *chartInstanceVar)
{
  disable_c5_modelo_FK_trial_2_testes
    ((SFc5_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_modelo_FK_trial_2_testes(void *chartInstanceVar)
{
  sf_c5_modelo_FK_trial_2_testes((SFc5_modelo_FK_trial_2_testesInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_modelo_FK_trial_2_testes
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_modelo_FK_trial_2_testes
    ((SFc5_modelo_FK_trial_2_testesInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_modelo_FK_trial_2_testes();/* state var info */
...
extern void sf_internal_set_sim_state_c5_modelo_FK_trial_2_testes(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c5_modelo_FK_trial_2_testes
    ((SFc5_modelo_FK_trial_2_testesInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_modelo_FK_trial_2_testes
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c5_modelo_FK_trial_2_testes(S);
}

static void sf_opaque_set_sim_state_c5_modelo_FK_trial_2_testes(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c5_modelo_FK_trial_2_testes(S, st);
}

static void sf_opaque_terminate_c5_modelo_FK_trial_2_testes(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_modelo_FK_trial_2_testesInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c5_modelo_FK_trial_2_testes
      ((SFc5_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_modelo_FK_trial_2_testes
    ((SFc5_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_modelo_FK_trial_2_testes(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c5_modelo_FK_trial_2_testes
      ((SFc5_modelo_FK_trial_2_testesInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c5_modelo_FK_trial_2_testes(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c5_modelo_FK_trial_2_testes(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_modelo_FK_trial_2_testes(SimStruct *S)
{
  SFc5_modelo_FK_trial_2_testesInstanceStruct *chartInstance;
  chartInstance = (SFc5_modelo_FK_trial_2_testesInstanceStruct *)utMalloc(sizeof
    (SFc5_modelo_FK_trial_2_testesInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_modelo_FK_trial_2_testesInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c5_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c5_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_modelo_FK_trial_2_testes;
...
void c5_modelo_FK_trial_2_testes_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_modelo_FK_trial_2_testes(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_modelo_FK_trial_2_testes(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_modelo_FK_trial_2_testes(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_modelo_FK_trial_2_testes_method_dispatcher.\n"
