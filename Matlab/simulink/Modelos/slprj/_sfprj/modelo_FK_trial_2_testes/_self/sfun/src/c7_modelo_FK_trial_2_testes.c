...
static void initialize_c7_modelo_FK_trial_2_testes
  (SFc7_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void initialize_params_c7_modelo_FK_trial_2_testes
  (SFc7_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void enable_c7_modelo_FK_trial_2_testes
  (SFc7_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void disable_c7_modelo_FK_trial_2_testes
  (SFc7_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void c7_update_debugger_state_c7_modelo_FK_trial_2_testes
  (SFc7_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_modelo_FK_trial_2_testes
  (SFc7_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void set_sim_state_c7_modelo_FK_trial_2_testes
  (SFc7_modelo_FK_trial_2_testesInstanceStruct *chartInstance, const mxArray
   *c7_st);
static void finalize_c7_modelo_FK_trial_2_testes
  (SFc7_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void sf_c7_modelo_FK_trial_2_testes
  (SFc7_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void c7_chartstep_c7_modelo_FK_trial_2_testes
  (SFc7_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void initSimStructsc7_modelo_FK_trial_2_testes
  (SFc7_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void registerMessagesc7_modelo_FK_trial_2_testes
  (SFc7_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber);
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData);
static void c7_emlrt_marshallIn(SFc7_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c7_u_recuperado, const char_T *c7_identifier,
  real_T c7_y[3]);
static void c7_b_emlrt_marshallIn(SFc7_modelo_FK_trial_2_testesInstanceStruct
...
static const mxArray *c7_b_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static real_T c7_c_emlrt_marshallIn(SFc7_modelo_FK_trial_2_testesInstanceStruct *
  chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static const mxArray *c7_c_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_d_emlrt_marshallIn(SFc7_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId,
  real_T c7_y[9]);
static void c7_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static void c7_info_helper(c7_ResolvedFunctionInfo c7_info[45]);
static void c7_diag(SFc7_modelo_FK_trial_2_testesInstanceStruct *chartInstance,
                    real_T c7_v[3], real_T c7_d[9]);
static void c7_inv(SFc7_modelo_FK_trial_2_testesInstanceStruct *chartInstance,
                   real_T c7_x[9], real_T c7_y[9]);
static void c7_inv3x3(SFc7_modelo_FK_trial_2_testesInstanceStruct *chartInstance,
                      real_T c7_x[9], real_T c7_y[9]);
static real_T c7_norm(SFc7_modelo_FK_trial_2_testesInstanceStruct *chartInstance,
                      real_T c7_x[9]);
static void c7_eml_warning(SFc7_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance);
static void c7_b_eml_warning(SFc7_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, char_T c7_varargin_2[14]);
static void c7_eml_scalar_eg(SFc7_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance);
static void c7_b_eml_scalar_eg(SFc7_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance);
static void c7_e_emlrt_marshallIn(SFc7_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c7_sprintf, const char_T *c7_identifier, char_T
  c7_y[14]);
static void c7_f_emlrt_marshallIn(SFc7_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId,
  char_T c7_y[14]);
static const mxArray *c7_d_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static int32_T c7_g_emlrt_marshallIn(SFc7_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static uint8_T c7_h_emlrt_marshallIn(SFc7_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c7_b_is_active_c7_modelo_FK_trial_2_testes,
  const char_T *c7_identifier);
static uint8_T c7_i_emlrt_marshallIn(SFc7_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void init_dsm_address_info(SFc7_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance);
  ...
  (SFc7_modelo_FK_trial_2_testesInstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_modelo_FK_trial_2_testes = 0U;
}
  ...
  (SFc7_modelo_FK_trial_2_testesInstanceStruct *chartInstance)
{
  ...
  c7_hoistedGlobal = chartInstance->c7_is_active_c7_modelo_FK_trial_2_testes;
   ...
   *c7_st)
{
  ...
  chartInstance->c7_is_active_c7_modelo_FK_trial_2_testes =
    c7_h_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 1)),
    "is_active_c7_modelo_FK_trial_2_testes");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_modelo_FK_trial_2_testes(chartInstance);
  ...
  (SFc7_modelo_FK_trial_2_testesInstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_sfEvent = CALL_EVENT;
  c7_chartstep_c7_modelo_FK_trial_2_testes(chartInstance);
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  const mxArray *c7_y = NULL;
  SFc7_modelo_FK_trial_2_testesInstanceStruct *chartInstance;
  chartInstance = (SFc7_modelo_FK_trial_2_testesInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c7_modelo_FK_trial_2_testes_get_eml_resolved_functions_info
  (void)
{
  ...
  const char_T *c7_identifier)
{
  ...
  c7_y = c7_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c7_b_is_active_c7_modelo_FK_trial_2_testes), &c7_thisId);
  sf_mex_destroy(&c7_b_is_active_c7_modelo_FK_trial_2_testes);
  return c7_y;
}
...
void sf_c7_modelo_FK_trial_2_testes_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c7_modelo_FK_trial_2_testes_get_autoinheritance_info(void)
{
...
mxArray *sf_c7_modelo_FK_trial_2_testes_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c7_modelo_FK_trial_2_testes(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"u_recuperado\",},{M[8],M[0],T\"is_active_c7_modelo_FK_trial_2_testes\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_modelo_FK_trial_2_testes_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c7_modelo_FK_trial_2_testes(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_modelo_FK_trial_2_testesInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c7_modelo_FK_trial_2_testes
    ((SFc7_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
  initialize_c7_modelo_FK_trial_2_testes
    ((SFc7_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c7_modelo_FK_trial_2_testes(void *chartInstanceVar)
{
  enable_c7_modelo_FK_trial_2_testes
    ((SFc7_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c7_modelo_FK_trial_2_testes(void *chartInstanceVar)
{
  disable_c7_modelo_FK_trial_2_testes
    ((SFc7_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c7_modelo_FK_trial_2_testes(void *chartInstanceVar)
{
  sf_c7_modelo_FK_trial_2_testes((SFc7_modelo_FK_trial_2_testesInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c7_modelo_FK_trial_2_testes
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c7_modelo_FK_trial_2_testes
    ((SFc7_modelo_FK_trial_2_testesInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c7_modelo_FK_trial_2_testes();/* state var info */
...
extern void sf_internal_set_sim_state_c7_modelo_FK_trial_2_testes(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c7_modelo_FK_trial_2_testes
    ((SFc7_modelo_FK_trial_2_testesInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c7_modelo_FK_trial_2_testes
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c7_modelo_FK_trial_2_testes(S);
}

static void sf_opaque_set_sim_state_c7_modelo_FK_trial_2_testes(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c7_modelo_FK_trial_2_testes(S, st);
}

static void sf_opaque_terminate_c7_modelo_FK_trial_2_testes(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_modelo_FK_trial_2_testesInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c7_modelo_FK_trial_2_testes
      ((SFc7_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc7_modelo_FK_trial_2_testes
    ((SFc7_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_modelo_FK_trial_2_testes(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c7_modelo_FK_trial_2_testes
      ((SFc7_modelo_FK_trial_2_testesInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c7_modelo_FK_trial_2_testes(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c7_modelo_FK_trial_2_testes(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_modelo_FK_trial_2_testes(SimStruct *S)
{
  SFc7_modelo_FK_trial_2_testesInstanceStruct *chartInstance;
  chartInstance = (SFc7_modelo_FK_trial_2_testesInstanceStruct *)utMalloc(sizeof
    (SFc7_modelo_FK_trial_2_testesInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc7_modelo_FK_trial_2_testesInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c7_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c7_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c7_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c7_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c7_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c7_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c7_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c7_modelo_FK_trial_2_testes;
...
void c7_modelo_FK_trial_2_testes_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_modelo_FK_trial_2_testes(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_modelo_FK_trial_2_testes(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_modelo_FK_trial_2_testes(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_modelo_FK_trial_2_testes_method_dispatcher.\n"
