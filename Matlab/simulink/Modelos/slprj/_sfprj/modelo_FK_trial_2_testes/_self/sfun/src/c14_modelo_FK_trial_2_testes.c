...
static void initialize_c14_modelo_FK_trial_2_testes
  (SFc14_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void initialize_params_c14_modelo_FK_trial_2_testes
  (SFc14_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void enable_c14_modelo_FK_trial_2_testes
  (SFc14_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void disable_c14_modelo_FK_trial_2_testes
  (SFc14_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void c14_update_debugger_state_c14_modelo_FK_trial_2_testes
  (SFc14_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c14_modelo_FK_trial_2_testes
  (SFc14_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void set_sim_state_c14_modelo_FK_trial_2_testes
  (SFc14_modelo_FK_trial_2_testesInstanceStruct *chartInstance, const mxArray
   *c14_st);
static void finalize_c14_modelo_FK_trial_2_testes
  (SFc14_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void sf_c14_modelo_FK_trial_2_testes
  (SFc14_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void initSimStructsc14_modelo_FK_trial_2_testes
  (SFc14_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void registerMessagesc14_modelo_FK_trial_2_testes
  (SFc14_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
...
static const mxArray *c14_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static void c14_emlrt_marshallIn(SFc14_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c14_xe, const char_T *c14_identifier, real_T
  c14_y[7]);
static void c14_b_emlrt_marshallIn(SFc14_modelo_FK_trial_2_testesInstanceStruct *
...
static uint8_T c14_e_emlrt_marshallIn
  (SFc14_modelo_FK_trial_2_testesInstanceStruct *chartInstance, const mxArray
   *c14_b_is_active_c14_modelo_FK_trial_2_testes, const char_T *c14_identifier);
static uint8_T c14_f_emlrt_marshallIn
  (SFc14_modelo_FK_trial_2_testesInstanceStruct *chartInstance, const mxArray
   *c14_u, const emlrtMsgIdentifier *c14_parentId);
static void init_dsm_address_info(SFc14_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance);
  ...
  (SFc14_modelo_FK_trial_2_testesInstanceStruct *chartInstance)
{
  ...
  chartInstance->c14_is_active_c14_modelo_FK_trial_2_testes = 0U;
}
  ...
  (SFc14_modelo_FK_trial_2_testesInstanceStruct *chartInstance)
{
  ...
  c14_hoistedGlobal = chartInstance->c14_is_active_c14_modelo_FK_trial_2_testes;
   ...
   *c14_st)
{
  ...
  chartInstance->c14_is_active_c14_modelo_FK_trial_2_testes =
    c14_e_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c14_u, 1)),
    "is_active_c14_modelo_FK_trial_2_testes");
  sf_mex_destroy(&c14_u);
  c14_update_debugger_state_c14_modelo_FK_trial_2_testes(chartInstance);
  ...
  *c14_inData)
{
  ...
  const mxArray *c14_y = NULL;
  SFc14_modelo_FK_trial_2_testesInstanceStruct *chartInstance;
  chartInstance = (SFc14_modelo_FK_trial_2_testesInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c14_modelo_FK_trial_2_testes_get_eml_resolved_functions_info
  (void)
{
   ...
   *c14_b_is_active_c14_modelo_FK_trial_2_testes, const char_T *c14_identifier)
{
  ...
  c14_y = c14_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c14_b_is_active_c14_modelo_FK_trial_2_testes), &c14_thisId);
  sf_mex_destroy(&c14_b_is_active_c14_modelo_FK_trial_2_testes);
  return c14_y;
}
...
void sf_c14_modelo_FK_trial_2_testes_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c14_modelo_FK_trial_2_testes_get_autoinheritance_info(void)
{
...
mxArray *sf_c14_modelo_FK_trial_2_testes_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c14_modelo_FK_trial_2_testes(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"xe\",},{M[8],M[0],T\"is_active_c14_modelo_FK_trial_2_testes\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c14_modelo_FK_trial_2_testes_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c14_modelo_FK_trial_2_testes(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc14_modelo_FK_trial_2_testesInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c14_modelo_FK_trial_2_testes
    ((SFc14_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
  initialize_c14_modelo_FK_trial_2_testes
    ((SFc14_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c14_modelo_FK_trial_2_testes(void *chartInstanceVar)
{
  enable_c14_modelo_FK_trial_2_testes
    ((SFc14_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c14_modelo_FK_trial_2_testes(void
  *chartInstanceVar)
{
  disable_c14_modelo_FK_trial_2_testes
    ((SFc14_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c14_modelo_FK_trial_2_testes(void
  *chartInstanceVar)
{
  sf_c14_modelo_FK_trial_2_testes((SFc14_modelo_FK_trial_2_testesInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c14_modelo_FK_trial_2_testes
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c14_modelo_FK_trial_2_testes
    ((SFc14_modelo_FK_trial_2_testesInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c14_modelo_FK_trial_2_testes();/* state var info */
...
extern void sf_internal_set_sim_state_c14_modelo_FK_trial_2_testes(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c14_modelo_FK_trial_2_testes
    ((SFc14_modelo_FK_trial_2_testesInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c14_modelo_FK_trial_2_testes
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c14_modelo_FK_trial_2_testes(S);
}

static void sf_opaque_set_sim_state_c14_modelo_FK_trial_2_testes(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c14_modelo_FK_trial_2_testes(S, st);
}

static void sf_opaque_terminate_c14_modelo_FK_trial_2_testes(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc14_modelo_FK_trial_2_testesInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c14_modelo_FK_trial_2_testes
      ((SFc14_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc14_modelo_FK_trial_2_testes
    ((SFc14_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c14_modelo_FK_trial_2_testes(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c14_modelo_FK_trial_2_testes
      ((SFc14_modelo_FK_trial_2_testesInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c14_modelo_FK_trial_2_testes(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c14_modelo_FK_trial_2_testes(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c14_modelo_FK_trial_2_testes(SimStruct *S)
{
  SFc14_modelo_FK_trial_2_testesInstanceStruct *chartInstance;
  chartInstance = (SFc14_modelo_FK_trial_2_testesInstanceStruct *)utMalloc
    (sizeof(SFc14_modelo_FK_trial_2_testesInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc14_modelo_FK_trial_2_testesInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c14_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c14_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c14_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c14_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c14_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c14_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c14_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c14_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c14_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.mdlStart = mdlStart_c14_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c14_modelo_FK_trial_2_testes;
...
void c14_modelo_FK_trial_2_testes_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c14_modelo_FK_trial_2_testes(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c14_modelo_FK_trial_2_testes(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c14_modelo_FK_trial_2_testes(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c14_modelo_FK_trial_2_testes_method_dispatcher.\n"
