...
static void initialize_c12_modelo_FK_trial_2_testes
  (SFc12_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void initialize_params_c12_modelo_FK_trial_2_testes
  (SFc12_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void enable_c12_modelo_FK_trial_2_testes
  (SFc12_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void disable_c12_modelo_FK_trial_2_testes
  (SFc12_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void c12_update_debugger_state_c12_modelo_FK_trial_2_testes
  (SFc12_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c12_modelo_FK_trial_2_testes
  (SFc12_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void set_sim_state_c12_modelo_FK_trial_2_testes
  (SFc12_modelo_FK_trial_2_testesInstanceStruct *chartInstance, const mxArray
   *c12_st);
static void finalize_c12_modelo_FK_trial_2_testes
  (SFc12_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void sf_c12_modelo_FK_trial_2_testes
  (SFc12_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void c12_chartstep_c12_modelo_FK_trial_2_testes
  (SFc12_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void initSimStructsc12_modelo_FK_trial_2_testes
  (SFc12_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void registerMessagesc12_modelo_FK_trial_2_testes
  (SFc12_modelo_FK_trial_2_testesInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c12_machineNumber, uint32_T
  c12_chartNumber);
static const mxArray *c12_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_emlrt_marshallIn(SFc12_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, const mxArray *c12_wr, const char_T *c12_identifier, real_T
  c12_y[3]);
static void c12_b_emlrt_marshallIn(SFc12_modelo_FK_trial_2_testesInstanceStruct *
...
static const mxArray *c12_c_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_d_emlrt_marshallIn(SFc12_modelo_FK_trial_2_testesInstanceStruct *
  chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId,
  real_T c12_y[9]);
...
static void c12_eml_scalar_eg(SFc12_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance);
static void c12_randn(SFc12_modelo_FK_trial_2_testesInstanceStruct
                      *chartInstance, real_T c12_r[3]);
static void c12_eml_rand_mcg16807(SFc12_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, uint32_T c12_e_state, uint32_T *c12_f_state, real_T *c12_r);
static void c12_genrandu(SFc12_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, uint32_T c12_s, uint32_T *c12_e_state, real_T *c12_r);
static void c12_eml_rand_shr3cong(SFc12_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, uint32_T c12_e_state[2], uint32_T c12_f_state[2], real_T
  *c12_r);
static real_T c12_abs(SFc12_modelo_FK_trial_2_testesInstanceStruct
                      *chartInstance, real_T c12_x);
static void c12_eml_rand_mt19937ar(SFc12_modelo_FK_trial_2_testesInstanceStruct *
  chartInstance, uint32_T c12_e_state[625]);
static void c12_twister_state_vector
  (SFc12_modelo_FK_trial_2_testesInstanceStruct *chartInstance, uint32_T c12_mt
   [625], real_T c12_seed, uint32_T c12_b_mt[625]);
static void c12_b_eml_rand_mt19937ar
  (SFc12_modelo_FK_trial_2_testesInstanceStruct *chartInstance, uint32_T
   c12_e_state[625], uint32_T c12_f_state[625], real_T *c12_r);
static void c12_assert_valid_state(SFc12_modelo_FK_trial_2_testesInstanceStruct *
  chartInstance);
static void c12_genrand_uint32_vector
  (SFc12_modelo_FK_trial_2_testesInstanceStruct *chartInstance, uint32_T c12_mt
   [625], uint32_T c12_b_mt[625], uint32_T c12_u[2]);
static void c12_b_genrandu(SFc12_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, uint32_T c12_mt[625], uint32_T c12_b_mt[625], real_T *c12_r);
static void c12_eml_error(SFc12_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance);
...
static uint32_T c12_k_emlrt_marshallIn
  (SFc12_modelo_FK_trial_2_testesInstanceStruct *chartInstance, const mxArray
   *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_l_emlrt_marshallIn(SFc12_modelo_FK_trial_2_testesInstanceStruct *
  chartInstance, const mxArray *c12_e_state, const char_T *c12_identifier,
  uint32_T c12_y[625]);
static void c12_m_emlrt_marshallIn(SFc12_modelo_FK_trial_2_testesInstanceStruct *
  chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId,
  uint32_T c12_y[625]);
static void c12_n_emlrt_marshallIn(SFc12_modelo_FK_trial_2_testesInstanceStruct *
  chartInstance, const mxArray *c12_e_state, const char_T *c12_identifier,
  uint32_T c12_y[2]);
static void c12_o_emlrt_marshallIn(SFc12_modelo_FK_trial_2_testesInstanceStruct *
  chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId,
  uint32_T c12_y[2]);
static void c12_p_emlrt_marshallIn(SFc12_modelo_FK_trial_2_testesInstanceStruct *
  chartInstance, const mxArray *c12_e_state, const char_T *c12_identifier,
  uint32_T c12_y[2]);
static void c12_q_emlrt_marshallIn(SFc12_modelo_FK_trial_2_testesInstanceStruct *
  chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId,
  uint32_T c12_y[2]);
static uint8_T c12_r_emlrt_marshallIn
  (SFc12_modelo_FK_trial_2_testesInstanceStruct *chartInstance, const mxArray
   *c12_b_is_active_c12_modelo_FK_trial_2_testes, const char_T *c12_identifier);
...
static real_T c12_c_genrandu(SFc12_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance, uint32_T c12_mt[625]);
static void init_dsm_address_info(SFc12_modelo_FK_trial_2_testesInstanceStruct
  *chartInstance);
  ...
  (SFc12_modelo_FK_trial_2_testesInstanceStruct *chartInstance)
{
  ...
  chartInstance->c12_is_active_c12_modelo_FK_trial_2_testes = 0U;
}
  ...
  (SFc12_modelo_FK_trial_2_testesInstanceStruct *chartInstance)
{
  ...
  c12_d_hoistedGlobal =
    chartInstance->c12_is_active_c12_modelo_FK_trial_2_testes;
   ...
   *c12_st)
{
  ...
  chartInstance->c12_is_active_c12_modelo_FK_trial_2_testes =
    ...
    "is_active_c12_modelo_FK_trial_2_testes");
  sf_mex_destroy(&c12_u);
  c12_update_debugger_state_c12_modelo_FK_trial_2_testes(chartInstance);
  ...
  (SFc12_modelo_FK_trial_2_testesInstanceStruct *chartInstance)
{
  ...
  chartInstance->c12_sfEvent = CALL_EVENT;
  c12_chartstep_c12_modelo_FK_trial_2_testes(chartInstance);
  ...
  *c12_inData)
{
  ...
  const mxArray *c12_y = NULL;
  SFc12_modelo_FK_trial_2_testesInstanceStruct *chartInstance;
  chartInstance = (SFc12_modelo_FK_trial_2_testesInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c12_modelo_FK_trial_2_testes_get_eml_resolved_functions_info
  (void)
{
   ...
   *c12_b_is_active_c12_modelo_FK_trial_2_testes, const char_T *c12_identifier)
{
  ...
  c12_y = c12_s_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c12_b_is_active_c12_modelo_FK_trial_2_testes), &c12_thisId);
  sf_mex_destroy(&c12_b_is_active_c12_modelo_FK_trial_2_testes);
  return c12_y;
}
...
void sf_c12_modelo_FK_trial_2_testes_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c12_modelo_FK_trial_2_testes_get_autoinheritance_info(void)
{
...
static void sf_opaque_initialize_c12_modelo_FK_trial_2_testes(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc12_modelo_FK_trial_2_testesInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c12_modelo_FK_trial_2_testes
    ((SFc12_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
  initialize_c12_modelo_FK_trial_2_testes
    ((SFc12_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c12_modelo_FK_trial_2_testes(void *chartInstanceVar)
{
  enable_c12_modelo_FK_trial_2_testes
    ((SFc12_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c12_modelo_FK_trial_2_testes(void
  *chartInstanceVar)
{
  disable_c12_modelo_FK_trial_2_testes
    ((SFc12_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c12_modelo_FK_trial_2_testes(void
  *chartInstanceVar)
{
  sf_c12_modelo_FK_trial_2_testes((SFc12_modelo_FK_trial_2_testesInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c12_modelo_FK_trial_2_testes
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c12_modelo_FK_trial_2_testes
    ((SFc12_modelo_FK_trial_2_testesInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c12_modelo_FK_trial_2_testes();/* state var info */
...
extern void sf_internal_set_sim_state_c12_modelo_FK_trial_2_testes(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c12_modelo_FK_trial_2_testes
    ((SFc12_modelo_FK_trial_2_testesInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c12_modelo_FK_trial_2_testes
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c12_modelo_FK_trial_2_testes(S);
}

static void sf_opaque_set_sim_state_c12_modelo_FK_trial_2_testes(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c12_modelo_FK_trial_2_testes(S, st);
}

static void sf_opaque_terminate_c12_modelo_FK_trial_2_testes(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc12_modelo_FK_trial_2_testesInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c12_modelo_FK_trial_2_testes
      ((SFc12_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc12_modelo_FK_trial_2_testes
    ((SFc12_modelo_FK_trial_2_testesInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c12_modelo_FK_trial_2_testes(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c12_modelo_FK_trial_2_testes
      ((SFc12_modelo_FK_trial_2_testesInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c12_modelo_FK_trial_2_testes(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c12_modelo_FK_trial_2_testes(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c12_modelo_FK_trial_2_testes(SimStruct *S)
{
  SFc12_modelo_FK_trial_2_testesInstanceStruct *chartInstance;
  chartInstance = (SFc12_modelo_FK_trial_2_testesInstanceStruct *)utMalloc
    (sizeof(SFc12_modelo_FK_trial_2_testesInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc12_modelo_FK_trial_2_testesInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c12_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c12_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c12_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c12_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c12_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c12_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c12_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c12_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c12_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.mdlStart = mdlStart_c12_modelo_FK_trial_2_testes;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c12_modelo_FK_trial_2_testes;
...
void c12_modelo_FK_trial_2_testes_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c12_modelo_FK_trial_2_testes(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c12_modelo_FK_trial_2_testes(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c12_modelo_FK_trial_2_testes(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c12_modelo_FK_trial_2_testes_method_dispatcher.\n"
