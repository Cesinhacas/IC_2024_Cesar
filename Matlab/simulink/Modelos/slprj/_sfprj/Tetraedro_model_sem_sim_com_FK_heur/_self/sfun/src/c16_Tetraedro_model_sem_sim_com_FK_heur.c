...
#include "c16_Tetraedro_model_sem_sim_com_FK_heur.h"
...
static void initialize_c16_Tetraedro_model_sem_sim_com_FK_heur
  (SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance);
static void initialize_params_c16_Tetraedro_model_sem_sim_com_FK_heur
  (SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance);
static void enable_c16_Tetraedro_model_sem_sim_com_FK_heur
  (SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance);
static void disable_c16_Tetraedro_model_sem_sim_com_FK_heur
  (SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance);
static void c16_update_debugger_state_c16_Tetraedro_model_sem_sim_com_FK_heu
  (SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c16_Tetraedro_model_sem_sim_com_FK_heur
  (SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance);
static void set_sim_state_c16_Tetraedro_model_sem_sim_com_FK_heur
  (SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance, const
   mxArray *c16_st);
static void finalize_c16_Tetraedro_model_sem_sim_com_FK_heur
  (SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance);
static void sf_c16_Tetraedro_model_sem_sim_com_FK_heur
  (SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance);
static void c16_chartstep_c16_Tetraedro_model_sem_sim_com_FK_heur
  (SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance);
static void initSimStructsc16_Tetraedro_model_sem_sim_com_FK_heur
  (SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance);
static void registerMessagesc16_Tetraedro_model_sem_sim_com_FK_heur
  (SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance);
...
static void c16_realmin(SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *
  chartInstance);
static void c16_eml_error
  (SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance);
...
static uint8_T c16_f_emlrt_marshallIn
  (SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance, const
   mxArray *c16_b_is_active_c16_Tetraedro_model_sem_sim_com_FK_heur, const
  ...
  (SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance)
{
  ...
  chartInstance->c16_is_active_c16_Tetraedro_model_sem_sim_com_FK_heur = 0U;
}
  ...
  (SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance)
{
  ...
  c16_hoistedGlobal =
    chartInstance->c16_is_active_c16_Tetraedro_model_sem_sim_com_FK_heur;
   ...
   mxArray *c16_st)
{
  ...
  chartInstance->c16_is_active_c16_Tetraedro_model_sem_sim_com_FK_heur =
    ...
    "is_active_c16_Tetraedro_model_sem_sim_com_FK_heur");
  sf_mex_destroy(&c16_u);
  c16_update_debugger_state_c16_Tetraedro_model_sem_sim_com_FK_heu(chartInstance);
  ...
  (SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance)
{
  ...
  chartInstance->c16_sfEvent = CALL_EVENT;
  c16_chartstep_c16_Tetraedro_model_sem_sim_com_FK_heur(chartInstance);
  ...
  *c16_inData)
{
  ...
  const mxArray *c16_y = NULL;
  SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance;
  chartInstance = (SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c16_Tetraedro_model_sem_sim_com_FK_heur_get_eml_resolved_functions_info
  (void)
{
   ...
   char_T *c16_identifier)
{
  ...
  c16_y = c16_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c16_b_is_active_c16_Tetraedro_model_sem_sim_com_FK_heur), &c16_thisId);
  sf_mex_destroy(&c16_b_is_active_c16_Tetraedro_model_sem_sim_com_FK_heur);
  return c16_y;
}
...
void sf_c16_Tetraedro_model_sem_sim_com_FK_heur_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c16_Tetraedro_model_sem_sim_com_FK_heur_get_autoinheritance_info
  (void)
{
...
mxArray *sf_c16_Tetraedro_model_sem_sim_com_FK_heur_third_party_uses_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c16_Tetraedro_model_sem_sim_com_FK_heur(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"qr\",},{M[8],M[0],T\"is_active_c16_Tetraedro_model_sem_sim_com_FK_heur\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c16_Tetraedro_model_sem_sim_com_FK_heur_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c16_Tetraedro_model_sem_sim_com_FK_heur(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c16_Tetraedro_model_sem_sim_com_FK_heur
    ((SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct*) chartInstanceVar);
  initialize_c16_Tetraedro_model_sem_sim_com_FK_heur
    ((SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c16_Tetraedro_model_sem_sim_com_FK_heur(void
  *chartInstanceVar)
{
  enable_c16_Tetraedro_model_sem_sim_com_FK_heur
    ((SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c16_Tetraedro_model_sem_sim_com_FK_heur(void
  *chartInstanceVar)
{
  disable_c16_Tetraedro_model_sem_sim_com_FK_heur
    ((SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c16_Tetraedro_model_sem_sim_com_FK_heur(void
  *chartInstanceVar)
{
  sf_c16_Tetraedro_model_sem_sim_com_FK_heur
    ((SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c16_Tetraedro_model_sem_sim_com_FK_heur(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c16_Tetraedro_model_sem_sim_com_FK_heur
    ((SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c16_Tetraedro_model_sem_sim_com_FK_heur();/* state var info */
...
extern void sf_internal_set_sim_state_c16_Tetraedro_model_sem_sim_com_FK_heur
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c16_Tetraedro_model_sem_sim_com_FK_heur
    ((SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c16_Tetraedro_model_sem_sim_com_FK_heur(SimStruct* S)
{
  return sf_internal_get_sim_state_c16_Tetraedro_model_sem_sim_com_FK_heur(S);
}

static void sf_opaque_set_sim_state_c16_Tetraedro_model_sem_sim_com_FK_heur
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c16_Tetraedro_model_sem_sim_com_FK_heur(S, st);
}

static void sf_opaque_terminate_c16_Tetraedro_model_sem_sim_com_FK_heur(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c16_Tetraedro_model_sem_sim_com_FK_heur
      ((SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc16_Tetraedro_model_sem_sim_com_FK_heur
    ((SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c16_Tetraedro_model_sem_sim_com_FK_heur
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c16_Tetraedro_model_sem_sim_com_FK_heur(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c16_Tetraedro_model_sem_sim_com_FK_heur(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c16_Tetraedro_model_sem_sim_com_FK_heur(SimStruct *S)
{
  SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance;
  chartInstance = (SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *)
    utMalloc(sizeof(SFc16_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c16_Tetraedro_model_sem_sim_com_FK_heur;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c16_Tetraedro_model_sem_sim_com_FK_heur;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c16_Tetraedro_model_sem_sim_com_FK_heur;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c16_Tetraedro_model_sem_sim_com_FK_heur;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c16_Tetraedro_model_sem_sim_com_FK_heur;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c16_Tetraedro_model_sem_sim_com_FK_heur;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c16_Tetraedro_model_sem_sim_com_FK_heur;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c16_Tetraedro_model_sem_sim_com_FK_heur;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c16_Tetraedro_model_sem_sim_com_FK_heur;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c16_Tetraedro_model_sem_sim_com_FK_heur;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c16_Tetraedro_model_sem_sim_com_FK_heur;
...
void c16_Tetraedro_model_sem_sim_com_FK_heur_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c16_Tetraedro_model_sem_sim_com_FK_heur(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c16_Tetraedro_model_sem_sim_com_FK_heur(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c16_Tetraedro_model_sem_sim_com_FK_heur(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c16_Tetraedro_model_sem_sim_com_FK_heur_method_dispatcher.\n"
