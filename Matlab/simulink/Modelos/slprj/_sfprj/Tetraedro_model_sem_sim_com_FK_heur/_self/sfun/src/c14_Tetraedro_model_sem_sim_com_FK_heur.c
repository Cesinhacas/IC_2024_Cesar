...
static void initialize_c14_Tetraedro_model_sem_sim_com_FK_heur
  (SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance);
static void initialize_params_c14_Tetraedro_model_sem_sim_com_FK_heur
  (SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance);
static void enable_c14_Tetraedro_model_sem_sim_com_FK_heur
  (SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance);
static void disable_c14_Tetraedro_model_sem_sim_com_FK_heur
  (SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance);
static void c14_update_debugger_state_c14_Tetraedro_model_sem_sim_com_FK_heu
  (SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c14_Tetraedro_model_sem_sim_com_FK_heur
  (SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance);
static void set_sim_state_c14_Tetraedro_model_sem_sim_com_FK_heur
  (SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance, const
   mxArray *c14_st);
static void finalize_c14_Tetraedro_model_sem_sim_com_FK_heur
  (SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance);
static void sf_c14_Tetraedro_model_sem_sim_com_FK_heur
  (SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance);
static void initSimStructsc14_Tetraedro_model_sem_sim_com_FK_heur
  (SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance);
static void registerMessagesc14_Tetraedro_model_sem_sim_com_FK_heur
  (SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance);
...
static void c14_emlrt_marshallIn
  (SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance, const
   mxArray *c14_xe, const char_T *c14_identifier, real_T c14_y[7]);
static void c14_b_emlrt_marshallIn
  (SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance, const
   mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId, real_T c14_y[7]);
...
static uint8_T c14_e_emlrt_marshallIn
  (SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance, const
   mxArray *c14_b_is_active_c14_Tetraedro_model_sem_sim_com_FK_heur, const
  ...
  (SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance)
{
  ...
  chartInstance->c14_is_active_c14_Tetraedro_model_sem_sim_com_FK_heur = 0U;
}
  ...
  (SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance)
{
  ...
  c14_hoistedGlobal =
    chartInstance->c14_is_active_c14_Tetraedro_model_sem_sim_com_FK_heur;
   ...
   mxArray *c14_st)
{
  ...
  chartInstance->c14_is_active_c14_Tetraedro_model_sem_sim_com_FK_heur =
    ...
    "is_active_c14_Tetraedro_model_sem_sim_com_FK_heur");
  sf_mex_destroy(&c14_u);
  c14_update_debugger_state_c14_Tetraedro_model_sem_sim_com_FK_heu(chartInstance);
  ...
  *c14_inData)
{
  ...
  const mxArray *c14_y = NULL;
  SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance;
  chartInstance = (SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *)
    chartInstanceVoid;
   ...
   char_T *c14_identifier)
{
  ...
  c14_y = c14_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c14_b_is_active_c14_Tetraedro_model_sem_sim_com_FK_heur), &c14_thisId);
  sf_mex_destroy(&c14_b_is_active_c14_Tetraedro_model_sem_sim_com_FK_heur);
  return c14_y;
}
...
void sf_c14_Tetraedro_model_sem_sim_com_FK_heur_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c14_Tetraedro_model_sem_sim_com_FK_heur_get_autoinheritance_info
  (void)
{
...
mxArray *sf_c14_Tetraedro_model_sem_sim_com_FK_heur_third_party_uses_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c14_Tetraedro_model_sem_sim_com_FK_heur(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"xe\",},{M[8],M[0],T\"is_active_c14_Tetraedro_model_sem_sim_com_FK_heur\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c14_Tetraedro_model_sem_sim_com_FK_heur_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c14_Tetraedro_model_sem_sim_com_FK_heur(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c14_Tetraedro_model_sem_sim_com_FK_heur
    ((SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct*) chartInstanceVar);
  initialize_c14_Tetraedro_model_sem_sim_com_FK_heur
    ((SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c14_Tetraedro_model_sem_sim_com_FK_heur(void
  *chartInstanceVar)
{
  enable_c14_Tetraedro_model_sem_sim_com_FK_heur
    ((SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c14_Tetraedro_model_sem_sim_com_FK_heur(void
  *chartInstanceVar)
{
  disable_c14_Tetraedro_model_sem_sim_com_FK_heur
    ((SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c14_Tetraedro_model_sem_sim_com_FK_heur(void
  *chartInstanceVar)
{
  sf_c14_Tetraedro_model_sem_sim_com_FK_heur
    ((SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c14_Tetraedro_model_sem_sim_com_FK_heur(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c14_Tetraedro_model_sem_sim_com_FK_heur
    ((SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c14_Tetraedro_model_sem_sim_com_FK_heur();/* state var info */
...
extern void sf_internal_set_sim_state_c14_Tetraedro_model_sem_sim_com_FK_heur
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c14_Tetraedro_model_sem_sim_com_FK_heur
    ((SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c14_Tetraedro_model_sem_sim_com_FK_heur(SimStruct* S)
{
  return sf_internal_get_sim_state_c14_Tetraedro_model_sem_sim_com_FK_heur(S);
}

static void sf_opaque_set_sim_state_c14_Tetraedro_model_sem_sim_com_FK_heur
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c14_Tetraedro_model_sem_sim_com_FK_heur(S, st);
}

static void sf_opaque_terminate_c14_Tetraedro_model_sem_sim_com_FK_heur(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c14_Tetraedro_model_sem_sim_com_FK_heur
      ((SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc14_Tetraedro_model_sem_sim_com_FK_heur
    ((SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c14_Tetraedro_model_sem_sim_com_FK_heur
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c14_Tetraedro_model_sem_sim_com_FK_heur(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c14_Tetraedro_model_sem_sim_com_FK_heur(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c14_Tetraedro_model_sem_sim_com_FK_heur(SimStruct *S)
{
  SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *chartInstance;
  chartInstance = (SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct *)
    utMalloc(sizeof(SFc14_Tetraedro_model_sem_sim_com_FK_heurInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c14_Tetraedro_model_sem_sim_com_FK_heur;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c14_Tetraedro_model_sem_sim_com_FK_heur;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c14_Tetraedro_model_sem_sim_com_FK_heur;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c14_Tetraedro_model_sem_sim_com_FK_heur;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c14_Tetraedro_model_sem_sim_com_FK_heur;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c14_Tetraedro_model_sem_sim_com_FK_heur;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c14_Tetraedro_model_sem_sim_com_FK_heur;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c14_Tetraedro_model_sem_sim_com_FK_heur;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c14_Tetraedro_model_sem_sim_com_FK_heur;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c14_Tetraedro_model_sem_sim_com_FK_heur;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c14_Tetraedro_model_sem_sim_com_FK_heur;
...
void c14_Tetraedro_model_sem_sim_com_FK_heur_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c14_Tetraedro_model_sem_sim_com_FK_heur(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c14_Tetraedro_model_sem_sim_com_FK_heur(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c14_Tetraedro_model_sem_sim_com_FK_heur(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c14_Tetraedro_model_sem_sim_com_FK_heur_method_dispatcher.\n"
