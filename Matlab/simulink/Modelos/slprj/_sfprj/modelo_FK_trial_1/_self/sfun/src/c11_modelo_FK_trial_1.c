...
static void initialize_c11_modelo_FK_trial_1
  (SFc11_modelo_FK_trial_1InstanceStruct *chartInstance);
static void initialize_params_c11_modelo_FK_trial_1
  (SFc11_modelo_FK_trial_1InstanceStruct *chartInstance);
static void enable_c11_modelo_FK_trial_1(SFc11_modelo_FK_trial_1InstanceStruct
  *chartInstance);
static void disable_c11_modelo_FK_trial_1(SFc11_modelo_FK_trial_1InstanceStruct *
  chartInstance);
static void c11_update_debugger_state_c11_modelo_FK_trial_1
  (SFc11_modelo_FK_trial_1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c11_modelo_FK_trial_1
  (SFc11_modelo_FK_trial_1InstanceStruct *chartInstance);
static void set_sim_state_c11_modelo_FK_trial_1
  (SFc11_modelo_FK_trial_1InstanceStruct *chartInstance, const mxArray *c11_st);
static void finalize_c11_modelo_FK_trial_1(SFc11_modelo_FK_trial_1InstanceStruct
  *chartInstance);
static void sf_c11_modelo_FK_trial_1(SFc11_modelo_FK_trial_1InstanceStruct
  *chartInstance);
static void c11_chartstep_c11_modelo_FK_trial_1
  (SFc11_modelo_FK_trial_1InstanceStruct *chartInstance);
static void initSimStructsc11_modelo_FK_trial_1
  (SFc11_modelo_FK_trial_1InstanceStruct *chartInstance);
static void registerMessagesc11_modelo_FK_trial_1
  (SFc11_modelo_FK_trial_1InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c11_machineNumber, uint32_T
  c11_chartNumber);
static const mxArray *c11_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static void c11_emlrt_marshallIn(SFc11_modelo_FK_trial_1InstanceStruct
  *chartInstance, const mxArray *c11_qr, const char_T *c11_identifier, real_T
  c11_y[4]);
static void c11_b_emlrt_marshallIn(SFc11_modelo_FK_trial_1InstanceStruct
...
static const mxArray *c11_c_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static real_T c11_c_emlrt_marshallIn(SFc11_modelo_FK_trial_1InstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId);
static void c11_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c11_mxArrayInData, const char_T *c11_varName, void *c11_outData);
static const mxArray *c11_d_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static void c11_d_emlrt_marshallIn(SFc11_modelo_FK_trial_1InstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId,
  real_T c11_y[3]);
...
static void c11_realmin(SFc11_modelo_FK_trial_1InstanceStruct *chartInstance);
static void c11_eml_error(SFc11_modelo_FK_trial_1InstanceStruct *chartInstance);
static const mxArray *c11_e_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static int32_T c11_e_emlrt_marshallIn(SFc11_modelo_FK_trial_1InstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId);
static void c11_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c11_mxArrayInData, const char_T *c11_varName, void *c11_outData);
static uint8_T c11_f_emlrt_marshallIn(SFc11_modelo_FK_trial_1InstanceStruct
  *chartInstance, const mxArray *c11_b_is_active_c11_modelo_FK_trial_1, const
  char_T *c11_identifier);
static uint8_T c11_g_emlrt_marshallIn(SFc11_modelo_FK_trial_1InstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId);
static void init_dsm_address_info(SFc11_modelo_FK_trial_1InstanceStruct
  *chartInstance);
  ...
  (SFc11_modelo_FK_trial_1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c11_is_active_c11_modelo_FK_trial_1 = 0U;
}
  ...
  (SFc11_modelo_FK_trial_1InstanceStruct *chartInstance)
{
  ...
  c11_hoistedGlobal = chartInstance->c11_is_active_c11_modelo_FK_trial_1;
  ...
  (SFc11_modelo_FK_trial_1InstanceStruct *chartInstance, const mxArray *c11_st)
{
  ...
  chartInstance->c11_is_active_c11_modelo_FK_trial_1 = c11_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c11_u, 1)),
     "is_active_c11_modelo_FK_trial_1");
  sf_mex_destroy(&c11_u);
  c11_update_debugger_state_c11_modelo_FK_trial_1(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c11_sfEvent = CALL_EVENT;
  c11_chartstep_c11_modelo_FK_trial_1(chartInstance);
  ...
  *c11_inData)
{
  ...
  const mxArray *c11_y = NULL;
  SFc11_modelo_FK_trial_1InstanceStruct *chartInstance;
  chartInstance = (SFc11_modelo_FK_trial_1InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c11_modelo_FK_trial_1_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c11_identifier)
{
  ...
  c11_y = c11_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c11_b_is_active_c11_modelo_FK_trial_1), &c11_thisId);
  sf_mex_destroy(&c11_b_is_active_c11_modelo_FK_trial_1);
  return c11_y;
}
...
void sf_c11_modelo_FK_trial_1_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c11_modelo_FK_trial_1_get_autoinheritance_info(void)
{
...
mxArray *sf_c11_modelo_FK_trial_1_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c11_modelo_FK_trial_1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"qr\",},{M[8],M[0],T\"is_active_c11_modelo_FK_trial_1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c11_modelo_FK_trial_1_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc11_modelo_FK_trial_1InstanceStruct *chartInstance;
    chartInstance = (SFc11_modelo_FK_trial_1InstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c11_modelo_FK_trial_1(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc11_modelo_FK_trial_1InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c11_modelo_FK_trial_1((SFc11_modelo_FK_trial_1InstanceStruct*)
    chartInstanceVar);
  initialize_c11_modelo_FK_trial_1((SFc11_modelo_FK_trial_1InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c11_modelo_FK_trial_1(void *chartInstanceVar)
{
  enable_c11_modelo_FK_trial_1((SFc11_modelo_FK_trial_1InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c11_modelo_FK_trial_1(void *chartInstanceVar)
{
  disable_c11_modelo_FK_trial_1((SFc11_modelo_FK_trial_1InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c11_modelo_FK_trial_1(void *chartInstanceVar)
{
  sf_c11_modelo_FK_trial_1((SFc11_modelo_FK_trial_1InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c11_modelo_FK_trial_1(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c11_modelo_FK_trial_1
    ((SFc11_modelo_FK_trial_1InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c11_modelo_FK_trial_1();/* state var info */
...
extern void sf_internal_set_sim_state_c11_modelo_FK_trial_1(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c11_modelo_FK_trial_1((SFc11_modelo_FK_trial_1InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c11_modelo_FK_trial_1(SimStruct* S)
{
  return sf_internal_get_sim_state_c11_modelo_FK_trial_1(S);
}

static void sf_opaque_set_sim_state_c11_modelo_FK_trial_1(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c11_modelo_FK_trial_1(S, st);
}

static void sf_opaque_terminate_c11_modelo_FK_trial_1(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc11_modelo_FK_trial_1InstanceStruct*) chartInstanceVar)
      ->S;
    ...
    finalize_c11_modelo_FK_trial_1((SFc11_modelo_FK_trial_1InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc11_modelo_FK_trial_1((SFc11_modelo_FK_trial_1InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c11_modelo_FK_trial_1(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c11_modelo_FK_trial_1
      ((SFc11_modelo_FK_trial_1InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c11_modelo_FK_trial_1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c11_modelo_FK_trial_1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c11_modelo_FK_trial_1(SimStruct *S)
{
  SFc11_modelo_FK_trial_1InstanceStruct *chartInstance;
  chartInstance = (SFc11_modelo_FK_trial_1InstanceStruct *)utMalloc(sizeof
    (SFc11_modelo_FK_trial_1InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc11_modelo_FK_trial_1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c11_modelo_FK_trial_1;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c11_modelo_FK_trial_1;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c11_modelo_FK_trial_1;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c11_modelo_FK_trial_1;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c11_modelo_FK_trial_1;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c11_modelo_FK_trial_1;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c11_modelo_FK_trial_1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c11_modelo_FK_trial_1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c11_modelo_FK_trial_1;
  chartInstance->chartInfo.mdlStart = mdlStart_c11_modelo_FK_trial_1;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c11_modelo_FK_trial_1;
...
void c11_modelo_FK_trial_1_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c11_modelo_FK_trial_1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c11_modelo_FK_trial_1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c11_modelo_FK_trial_1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c11_modelo_FK_trial_1_method_dispatcher.\n"
