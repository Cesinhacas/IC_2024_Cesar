...
static const char * c16_debug_family_names[6] = { "v", "ang", "nargin",
  "nargout", "q", "qr" };

/* Function Declarations */
static void initialize_c16_modelo_FK_trial_1
  (SFc16_modelo_FK_trial_1InstanceStruct *chartInstance);
static void initialize_params_c16_modelo_FK_trial_1
  (SFc16_modelo_FK_trial_1InstanceStruct *chartInstance);
static void enable_c16_modelo_FK_trial_1(SFc16_modelo_FK_trial_1InstanceStruct
  *chartInstance);
static void disable_c16_modelo_FK_trial_1(SFc16_modelo_FK_trial_1InstanceStruct *
  chartInstance);
static void c16_update_debugger_state_c16_modelo_FK_trial_1
  (SFc16_modelo_FK_trial_1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c16_modelo_FK_trial_1
  (SFc16_modelo_FK_trial_1InstanceStruct *chartInstance);
static void set_sim_state_c16_modelo_FK_trial_1
  (SFc16_modelo_FK_trial_1InstanceStruct *chartInstance, const mxArray *c16_st);
static void finalize_c16_modelo_FK_trial_1(SFc16_modelo_FK_trial_1InstanceStruct
  *chartInstance);
static void sf_c16_modelo_FK_trial_1(SFc16_modelo_FK_trial_1InstanceStruct
  *chartInstance);
static void c16_chartstep_c16_modelo_FK_trial_1
  (SFc16_modelo_FK_trial_1InstanceStruct *chartInstance);
static void initSimStructsc16_modelo_FK_trial_1
  (SFc16_modelo_FK_trial_1InstanceStruct *chartInstance);
static void registerMessagesc16_modelo_FK_trial_1
  (SFc16_modelo_FK_trial_1InstanceStruct *chartInstance);
...
static const mxArray *c16_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static void c16_emlrt_marshallIn(SFc16_modelo_FK_trial_1InstanceStruct
  *chartInstance, const mxArray *c16_qr, const char_T *c16_identifier, real_T
  c16_y[4]);
static void c16_b_emlrt_marshallIn(SFc16_modelo_FK_trial_1InstanceStruct
...
static const mxArray *c16_c_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static real_T c16_c_emlrt_marshallIn(SFc16_modelo_FK_trial_1InstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
...
static const mxArray *c16_d_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static void c16_d_emlrt_marshallIn(SFc16_modelo_FK_trial_1InstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId,
  real_T c16_y[3]);
static void c16_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c16_mxArrayInData, const char_T *c16_varName, void *c16_outData);
static void c16_info_helper(c16_ResolvedFunctionInfo c16_info[28]);
static void c16_realmin(SFc16_modelo_FK_trial_1InstanceStruct *chartInstance);
static void c16_eml_error(SFc16_modelo_FK_trial_1InstanceStruct *chartInstance);
static const mxArray *c16_e_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static int32_T c16_e_emlrt_marshallIn(SFc16_modelo_FK_trial_1InstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static void c16_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c16_mxArrayInData, const char_T *c16_varName, void *c16_outData);
static uint8_T c16_f_emlrt_marshallIn(SFc16_modelo_FK_trial_1InstanceStruct
  *chartInstance, const mxArray *c16_b_is_active_c16_modelo_FK_trial_1, const
  char_T *c16_identifier);
static uint8_T c16_g_emlrt_marshallIn(SFc16_modelo_FK_trial_1InstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static void init_dsm_address_info(SFc16_modelo_FK_trial_1InstanceStruct
  *chartInstance);
  ...
  (SFc16_modelo_FK_trial_1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c16_is_active_c16_modelo_FK_trial_1 = 0U;
}
  ...
  (SFc16_modelo_FK_trial_1InstanceStruct *chartInstance)
{
  ...
  real_T (*c16_qr)[4];
  c16_qr = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 1);
  c16_st = NULL;
  c16_st = NULL;
  c16_y = NULL;
  sf_mex_assign(&c16_y, sf_mex_createcellarray(2), FALSE);
  for (c16_i0 = 0; c16_i0 < 4; c16_i0++) {
    c16_u[c16_i0] = (*c16_qr)[c16_i0];
  }

  c16_b_y = NULL;
  sf_mex_assign(&c16_b_y, sf_mex_create("y", c16_u, 0, 0U, 1U, 0U, 2, 1, 4),
                FALSE);
  sf_mex_setcell(c16_y, 0, c16_b_y);
  c16_hoistedGlobal = chartInstance->c16_is_active_c16_modelo_FK_trial_1;
  ...
  (SFc16_modelo_FK_trial_1InstanceStruct *chartInstance, const mxArray *c16_st)
{
  ...
  c16_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c16_u, 0)), "qr",
                       c16_dv0);
  for (c16_i1 = 0; c16_i1 < 4; c16_i1++) {
    (*c16_qr)[c16_i1] = c16_dv0[c16_i1];
  }

  chartInstance->c16_is_active_c16_modelo_FK_trial_1 = c16_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c16_u, 1)),
     "is_active_c16_modelo_FK_trial_1");
  sf_mex_destroy(&c16_u);
  c16_update_debugger_state_c16_modelo_FK_trial_1(chartInstance);
  ...
  *chartInstance)
{
  ...
  for (c16_i2 = 0; c16_i2 < 4; c16_i2++) {
    _SFD_DATA_RANGE_CHECK((*c16_q)[c16_i2], 0U);
  }

  for (c16_i3 = 0; c16_i3 < 4; c16_i3++) {
    _SFD_DATA_RANGE_CHECK((*c16_qr)[c16_i3], 1U);
  }

  chartInstance->c16_sfEvent = CALL_EVENT;
  c16_chartstep_c16_modelo_FK_trial_1(chartInstance);
  ...
  (SFc16_modelo_FK_trial_1InstanceStruct *chartInstance)
{
  ...
  c16_b_qr = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  for (c16_i4 = 0; c16_i4 < 4; c16_i4++) {
    c16_q[c16_i4] = (*c16_b_q)[c16_i4];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 6U, 6U, c16_debug_family_names,
    c16_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c16_v, 0U, c16_d_sf_marshallOut,
    c16_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c16_ang, 1U, c16_c_sf_marshallOut,
    c16_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c16_nargin, 2U, c16_c_sf_marshallOut,
    c16_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c16_nargout, 3U, c16_c_sf_marshallOut,
    c16_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c16_q, 4U, c16_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c16_qr, 5U, c16_sf_marshallOut,
    c16_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c16_sfEvent, 4);
  for (c16_i5 = 0; c16_i5 < 4; c16_i5++) {
    c16_x[c16_i5] = c16_q[c16_i5];
  }

  c16_y = 0.0;
  c16_realmin(chartInstance);
  c16_scale = 2.2250738585072014E-308;
  for (c16_k = 1; c16_k < 5; c16_k++) {
    c16_b_k = c16_k;
    c16_b_x = c16_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
      "", (real_T)c16_b_k), 1, 4, 1, 0) - 1];
    c16_c_x = c16_b_x;
  ...
  c16_y = c16_scale * muDoubleScalarSqrt(c16_y);
  for (c16_i6 = 0; c16_i6 < 4; c16_i6++) {
    c16_x[c16_i6] = c16_q[c16_i6];
  }
  ...
  for (c16_i7 = 0; c16_i7 < 4; c16_i7++) {
    c16_q[c16_i7] = c16_x[c16_i7] / c16_c_y;
  }
  ...
  c16_d_y = 0.0;
  c16_realmin(chartInstance);
  c16_b_scale = 2.2250738585072014E-308;
  for (c16_c_k = 1; c16_c_k < 4; c16_c_k++) {
    c16_d_k = c16_c_k;
    c16_e_x = c16_d_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", (real_T)c16_d_k), 1, 3, 1, 0) - 1];
    c16_f_x = c16_e_x;
    c16_b_absxk = muDoubleScalarAbs(c16_f_x);
    if (c16_b_absxk > c16_b_scale) {
      c16_b_t = c16_b_scale / c16_b_absxk;
      c16_d_y = 1.0 + c16_d_y * c16_b_t * c16_b_t;
      c16_b_scale = c16_b_absxk;
    } else {
      c16_b_t = c16_b_absxk / c16_b_scale;
      c16_d_y += c16_b_t * c16_b_t;
    }
  }

  c16_d_y = c16_b_scale * muDoubleScalarSqrt(c16_d_y);
  c16_d_x[0] = c16_q[1];
  c16_d_x[1] = c16_q[2];
  c16_d_x[2] = c16_q[3];
  c16_b_B = c16_d_y;
  ...
  for (c16_i8 = 0; c16_i8 < 3; c16_i8++) {
    c16_v[c16_i8] = c16_d_x[c16_i8] / c16_f_y;
  }
  ...
  for (c16_i10 = 0; c16_i10 < 4; c16_i10++) {
    (*c16_b_qr)[c16_i10] = c16_qr[c16_i10];
  }
  ...
  *c16_inData)
{
  ...
  const mxArray *c16_y = NULL;
  SFc16_modelo_FK_trial_1InstanceStruct *chartInstance;
  chartInstance = (SFc16_modelo_FK_trial_1InstanceStruct *)chartInstanceVoid;
  c16_mxArrayOutData = NULL;
  for (c16_i11 = 0; c16_i11 < 4; c16_i11++) {
    c16_b_inData[c16_i11] = (*(real_T (*)[4])c16_inData)[c16_i11];
  }

  for (c16_i12 = 0; c16_i12 < 4; c16_i12++) {
    c16_u[c16_i12] = c16_b_inData[c16_i12];
  }
  ...
  c16_y[4])
{
  ...
  c16_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c16_qr), &c16_thisId, c16_y);
  sf_mex_destroy(&c16_qr);
}
  ...
  *c16_mxArrayInData, const char_T *c16_varName, void *c16_outData)
{
  ...
  SFc16_modelo_FK_trial_1InstanceStruct *chartInstance;
  chartInstance = (SFc16_modelo_FK_trial_1InstanceStruct *)chartInstanceVoid;
  c16_qr = sf_mex_dup(c16_mxArrayInData);
  ...
  for (c16_i14 = 0; c16_i14 < 4; c16_i14++) {
    (*(real_T (*)[4])c16_outData)[c16_i14] = c16_y[c16_i14];
  }
  ...
  *c16_inData)
{
  ...
  for (c16_i15 = 0; c16_i15 < 4; c16_i15++) {
    c16_b_inData[c16_i15] = (*(real_T (*)[4])c16_inData)[c16_i15];
  }

  for (c16_i16 = 0; c16_i16 < 4; c16_i16++) {
    c16_u[c16_i16] = c16_b_inData[c16_i16];
  }
  ...
  real_T c16_y[3])
{
  real_T c16_dv2[3];
  int32_T c16_i19;
  sf_mex_import(c16_parentId, sf_mex_dup(c16_u), c16_dv2, 1, 0, 0U, 1, 0U, 2, 1,
                3);
  ...
  *c16_mxArrayInData, const char_T *c16_varName, void *c16_outData)
{
  ...
  SFc16_modelo_FK_trial_1InstanceStruct *chartInstance;
  chartInstance = (SFc16_modelo_FK_trial_1InstanceStruct *)chartInstanceVoid;
  c16_v = sf_mex_dup(c16_mxArrayInData);
  c16_identifier = c16_varName;
  c16_thisId.fIdentifier = c16_identifier;
  c16_thisId.fParent = NULL;
  c16_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c16_v), &c16_thisId, c16_y);
  sf_mex_destroy(&c16_v);
  for (c16_i20 = 0; c16_i20 < 3; c16_i20++) {
    (*(real_T (*)[3])c16_outData)[c16_i20] = c16_y[c16_i20];
  }

  sf_mex_destroy(&c16_mxArrayInData);
}

const mxArray *sf_c16_modelo_FK_trial_1_get_eml_resolved_functions_info(void)
{
  const mxArray *c16_nameCaptureInfo;
  c16_ResolvedFunctionInfo c16_info[28];
  ...
  sf_mex_assign(&c16_m0, sf_mex_createstruct("nameCaptureInfo", 1, 28), FALSE);
  for (c16_i21 = 0; c16_i21 < 28; c16_i21++) {
    c16_r0 = &c16_info[c16_i21];
...
static void c16_info_helper(c16_ResolvedFunctionInfo c16_info[28])
{
  ...
  c16_info[0].fileTimeLo = 1336540094U;
  ...
  c16_info[1].fileTimeLo = 1323181378U;
  ...
  c16_info[2].fileTimeLo = 1299091176U;
  ...
  c16_info[3].fileTimeLo = 1299091168U;
  ...
  c16_info[4].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  c16_info[4].fileTimeLo = 1323181378U;
  ...
  c16_info[5].fileTimeLo = 1299091184U;
  ...
  c16_info[6].fileTimeLo = 1307669242U;
  ...
  c16_info[7].fileTimeLo = 1307669244U;
  ...
  c16_info[8].fileTimeLo = 1326738796U;
  ...
  c16_info[9].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  c16_info[9].fileTimeLo = 1323181378U;
  ...
  c16_info[10].fileTimeLo = 1286836778U;
  ...
  c16_info[11].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  c16_info[11].fileTimeLo = 1323181378U;
  ...
  c16_info[12].fileTimeLo = 1286836780U;
  ...
  c16_info[13].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  c16_info[13].fileTimeLo = 1323181378U;
  ...
  c16_info[14].fileTimeLo = 1286836778U;
  ...
  c16_info[15].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  c16_info[15].fileTimeLo = 1323181378U;
  ...
  c16_info[16].fileTimeLo = 1346528340U;
  ...
  c16_info[17].fileTimeLo = 1311273316U;
  ...
  c16_info[18].fileTimeLo = 1343848366U;
  ...
  c16_info[19].fileTimeLo = 1286836712U;
  ...
  c16_info[20].fileTimeLo = 1357962348U;
  c16_info[20].fileTimeHi = 0U;
  c16_info[20].mFileTimeLo = 1319744366U;
  ...
  c16_info[21].fileTimeLo = 1346528388U;
  ...
  c16_info[22].fileTimeLo = 1286836796U;
...
{
  int32_T c16_i22;
  static char_T c16_cv0[30] = { 'C', 'o', 'd', 'e', 'r', ':', 't', 'o', 'o', 'l',
  ...
  const mxArray *c16_y = NULL;
  int32_T c16_i23;
  static char_T c16_cv1[4] = { 'a', 'c', 'o', 's' };

  char_T c16_b_u[4];
  const mxArray *c16_b_y = NULL;
  for (c16_i22 = 0; c16_i22 < 30; c16_i22++) {
    c16_u[c16_i22] = c16_cv0[c16_i22];
  }
  ...
  for (c16_i23 = 0; c16_i23 < 4; c16_i23++) {
    c16_b_u[c16_i23] = c16_cv1[c16_i23];
  }
  ...
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId)
{
  int32_T c16_y;
  int32_T c16_i24;
  sf_mex_import(c16_parentId, sf_mex_dup(c16_u), &c16_i24, 1, 6, 0U, 0, 0U, 0);
  c16_y = c16_i24;
  sf_mex_destroy(&c16_u);
  return c16_y;
}
  ...
  char_T *c16_identifier)
{
  ...
  c16_y = c16_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c16_b_is_active_c16_modelo_FK_trial_1), &c16_thisId);
  sf_mex_destroy(&c16_b_is_active_c16_modelo_FK_trial_1);
  return c16_y;
}
...
void sf_c16_modelo_FK_trial_1_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c16_modelo_FK_trial_1_get_autoinheritance_info(void)
{
...
mxArray *sf_c16_modelo_FK_trial_1_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c16_modelo_FK_trial_1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"qr\",},{M[8],M[0],T\"is_active_c16_modelo_FK_trial_1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c16_modelo_FK_trial_1_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc16_modelo_FK_trial_1InstanceStruct *chartInstance;
    chartInstance = (SFc16_modelo_FK_trial_1InstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(1U, *c16_qr);
        }
      }
    } else {
...
static void sf_opaque_initialize_c16_modelo_FK_trial_1(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc16_modelo_FK_trial_1InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c16_modelo_FK_trial_1((SFc16_modelo_FK_trial_1InstanceStruct*)
    chartInstanceVar);
  initialize_c16_modelo_FK_trial_1((SFc16_modelo_FK_trial_1InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c16_modelo_FK_trial_1(void *chartInstanceVar)
{
  enable_c16_modelo_FK_trial_1((SFc16_modelo_FK_trial_1InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c16_modelo_FK_trial_1(void *chartInstanceVar)
{
  disable_c16_modelo_FK_trial_1((SFc16_modelo_FK_trial_1InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c16_modelo_FK_trial_1(void *chartInstanceVar)
{
  sf_c16_modelo_FK_trial_1((SFc16_modelo_FK_trial_1InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c16_modelo_FK_trial_1(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c16_modelo_FK_trial_1
    ((SFc16_modelo_FK_trial_1InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c16_modelo_FK_trial_1();/* state var info */
...
extern void sf_internal_set_sim_state_c16_modelo_FK_trial_1(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c16_modelo_FK_trial_1((SFc16_modelo_FK_trial_1InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c16_modelo_FK_trial_1(SimStruct* S)
{
  return sf_internal_get_sim_state_c16_modelo_FK_trial_1(S);
}

static void sf_opaque_set_sim_state_c16_modelo_FK_trial_1(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c16_modelo_FK_trial_1(S, st);
}

static void sf_opaque_terminate_c16_modelo_FK_trial_1(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc16_modelo_FK_trial_1InstanceStruct*) chartInstanceVar)
      ->S;
    ...
    finalize_c16_modelo_FK_trial_1((SFc16_modelo_FK_trial_1InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc16_modelo_FK_trial_1((SFc16_modelo_FK_trial_1InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c16_modelo_FK_trial_1(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c16_modelo_FK_trial_1
      ((SFc16_modelo_FK_trial_1InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c16_modelo_FK_trial_1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c16_modelo_FK_trial_1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c16_modelo_FK_trial_1(SimStruct *S)
{
  SFc16_modelo_FK_trial_1InstanceStruct *chartInstance;
  chartInstance = (SFc16_modelo_FK_trial_1InstanceStruct *)utMalloc(sizeof
    (SFc16_modelo_FK_trial_1InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc16_modelo_FK_trial_1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c16_modelo_FK_trial_1;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c16_modelo_FK_trial_1;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c16_modelo_FK_trial_1;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c16_modelo_FK_trial_1;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c16_modelo_FK_trial_1;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c16_modelo_FK_trial_1;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c16_modelo_FK_trial_1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c16_modelo_FK_trial_1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c16_modelo_FK_trial_1;
  chartInstance->chartInfo.mdlStart = mdlStart_c16_modelo_FK_trial_1;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c16_modelo_FK_trial_1;
...
void c16_modelo_FK_trial_1_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c16_modelo_FK_trial_1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c16_modelo_FK_trial_1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c16_modelo_FK_trial_1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c16_modelo_FK_trial_1_method_dispatcher.\n"
