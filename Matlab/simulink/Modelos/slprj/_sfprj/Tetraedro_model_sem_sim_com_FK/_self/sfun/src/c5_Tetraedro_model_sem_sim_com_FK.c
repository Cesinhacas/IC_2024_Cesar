...
static void initialize_c5_Tetraedro_model_sem_sim_com_FK
  (SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct *chartInstance);
static void initialize_params_c5_Tetraedro_model_sem_sim_com_FK
  (SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct *chartInstance);
static void enable_c5_Tetraedro_model_sem_sim_com_FK
  (SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct *chartInstance);
static void disable_c5_Tetraedro_model_sem_sim_com_FK
  (SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_Tetraedro_model_sem_sim_com_FK
  (SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_Tetraedro_model_sem_sim_com_FK
  (SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct *chartInstance);
static void set_sim_state_c5_Tetraedro_model_sem_sim_com_FK
  (SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct *chartInstance, const
   mxArray *c5_st);
static void finalize_c5_Tetraedro_model_sem_sim_com_FK
  (SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct *chartInstance);
static void sf_c5_Tetraedro_model_sem_sim_com_FK
  (SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct *chartInstance);
static void c5_chartstep_c5_Tetraedro_model_sem_sim_com_FK
  (SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct *chartInstance);
static void initSimStructsc5_Tetraedro_model_sem_sim_com_FK
  (SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct *chartInstance);
static void registerMessagesc5_Tetraedro_model_sem_sim_com_FK
  (SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct *chartInstance);
...
static void c5_diag(SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct
                    *chartInstance, real_T c5_v[3], real_T c5_d[9]);
static void c5_inv(SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct
                   *chartInstance, real_T c5_x[9], real_T c5_y[9]);
static void c5_inv3x3(SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct
                      *chartInstance, real_T c5_x[9], real_T c5_y[9]);
static real_T c5_norm(SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct
                      *chartInstance, real_T c5_x[9]);
static void c5_eml_warning(SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct
  *chartInstance);
static void c5_b_eml_warning(SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct
  *chartInstance, char_T c5_varargin_2[14]);
static void c5_eml_scalar_eg(SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct
  *chartInstance);
static void c5_b_eml_scalar_eg(SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct
  *chartInstance);
...
static uint8_T c5_h_emlrt_marshallIn
  (SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct *chartInstance, const
   mxArray *c5_b_is_active_c5_Tetraedro_model_sem_sim_com_FK, const char_T
   *c5_identifier);
  ...
  (SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_Tetraedro_model_sem_sim_com_FK = 0U;
}
  ...
  (SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct *chartInstance)
{
  ...
  c5_hoistedGlobal =
    chartInstance->c5_is_active_c5_Tetraedro_model_sem_sim_com_FK;
   ...
   mxArray *c5_st)
{
  ...
  chartInstance->c5_is_active_c5_Tetraedro_model_sem_sim_com_FK =
    ...
    "is_active_c5_Tetraedro_model_sem_sim_com_FK");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_Tetraedro_model_sem_sim_com_FK(chartInstance);
  ...
  (SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_sfEvent = CALL_EVENT;
  c5_chartstep_c5_Tetraedro_model_sem_sim_com_FK(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct *chartInstance;
  chartInstance = (SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c5_Tetraedro_model_sem_sim_com_FK_get_eml_resolved_functions_info(void)
{
   ...
   *c5_identifier)
{
  ...
  c5_y = c5_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_Tetraedro_model_sem_sim_com_FK), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_Tetraedro_model_sem_sim_com_FK);
  return c5_y;
}
...
void sf_c5_Tetraedro_model_sem_sim_com_FK_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_Tetraedro_model_sem_sim_com_FK_get_autoinheritance_info(void)
{
...
mxArray *sf_c5_Tetraedro_model_sem_sim_com_FK_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c5_Tetraedro_model_sem_sim_com_FK
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"u_recuperado\",},{M[8],M[0],T\"is_active_c5_Tetraedro_model_sem_sim_com_FK\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_Tetraedro_model_sem_sim_com_FK_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c5_Tetraedro_model_sem_sim_com_FK(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c5_Tetraedro_model_sem_sim_com_FK
    ((SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct*) chartInstanceVar);
  initialize_c5_Tetraedro_model_sem_sim_com_FK
    ((SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_Tetraedro_model_sem_sim_com_FK(void
  *chartInstanceVar)
{
  enable_c5_Tetraedro_model_sem_sim_com_FK
    ((SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_Tetraedro_model_sem_sim_com_FK(void
  *chartInstanceVar)
{
  disable_c5_Tetraedro_model_sem_sim_com_FK
    ((SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_Tetraedro_model_sem_sim_com_FK(void
  *chartInstanceVar)
{
  sf_c5_Tetraedro_model_sem_sim_com_FK
    ((SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c5_Tetraedro_model_sem_sim_com_FK(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_Tetraedro_model_sem_sim_com_FK
    ((SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_Tetraedro_model_sem_sim_com_FK();/* state var info */
...
extern void sf_internal_set_sim_state_c5_Tetraedro_model_sem_sim_com_FK
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c5_Tetraedro_model_sem_sim_com_FK
    ((SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct*)
     chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_Tetraedro_model_sem_sim_com_FK
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c5_Tetraedro_model_sem_sim_com_FK(S);
}

static void sf_opaque_set_sim_state_c5_Tetraedro_model_sem_sim_com_FK(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c5_Tetraedro_model_sem_sim_com_FK(S, st);
}

static void sf_opaque_terminate_c5_Tetraedro_model_sem_sim_com_FK(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c5_Tetraedro_model_sem_sim_com_FK
      ((SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_Tetraedro_model_sem_sim_com_FK
    ((SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_Tetraedro_model_sem_sim_com_FK(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c5_Tetraedro_model_sem_sim_com_FK
      ((SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c5_Tetraedro_model_sem_sim_com_FK(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c5_Tetraedro_model_sem_sim_com_FK(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_Tetraedro_model_sem_sim_com_FK(SimStruct *S)
{
  SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct *chartInstance;
  chartInstance = (SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct *)utMalloc
    (sizeof(SFc5_Tetraedro_model_sem_sim_com_FKInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_Tetraedro_model_sem_sim_com_FK;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_Tetraedro_model_sem_sim_com_FK;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_Tetraedro_model_sem_sim_com_FK;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c5_Tetraedro_model_sem_sim_com_FK;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c5_Tetraedro_model_sem_sim_com_FK;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_Tetraedro_model_sem_sim_com_FK;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_Tetraedro_model_sem_sim_com_FK;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_Tetraedro_model_sem_sim_com_FK;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_Tetraedro_model_sem_sim_com_FK;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_Tetraedro_model_sem_sim_com_FK;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_Tetraedro_model_sem_sim_com_FK;
...
void c5_Tetraedro_model_sem_sim_com_FK_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_Tetraedro_model_sem_sim_com_FK(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_Tetraedro_model_sem_sim_com_FK(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_Tetraedro_model_sem_sim_com_FK(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_Tetraedro_model_sem_sim_com_FK_method_dispatcher.\n"
