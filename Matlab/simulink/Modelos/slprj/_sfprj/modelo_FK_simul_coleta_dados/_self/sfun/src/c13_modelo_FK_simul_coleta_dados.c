...
static void initialize_c13_modelo_FK_simul_coleta_dados
  (SFc13_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance);
static void initialize_params_c13_modelo_FK_simul_coleta_dados
  (SFc13_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance);
static void enable_c13_modelo_FK_simul_coleta_dados
  (SFc13_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance);
static void disable_c13_modelo_FK_simul_coleta_dados
  (SFc13_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance);
static void c13_update_debugger_state_c13_modelo_FK_simul_coleta_dados
  (SFc13_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c13_modelo_FK_simul_coleta_dados
  (SFc13_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance);
static void set_sim_state_c13_modelo_FK_simul_coleta_dados
  (SFc13_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance, const
   mxArray *c13_st);
static void finalize_c13_modelo_FK_simul_coleta_dados
  (SFc13_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance);
static void sf_c13_modelo_FK_simul_coleta_dados
  (SFc13_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance);
static void c13_chartstep_c13_modelo_FK_simul_coleta_dados
  (SFc13_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance);
static void initSimStructsc13_modelo_FK_simul_coleta_dados
  (SFc13_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance);
static void registerMessagesc13_modelo_FK_simul_coleta_dados
  (SFc13_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance);
...
static void c13_inv3x3(SFc13_modelo_FK_simul_coleta_dadosInstanceStruct
  *chartInstance, real_T c13_x[9], real_T c13_y[9]);
static real_T c13_norm(SFc13_modelo_FK_simul_coleta_dadosInstanceStruct
  *chartInstance, real_T c13_x[9]);
static void c13_eml_warning(SFc13_modelo_FK_simul_coleta_dadosInstanceStruct
  *chartInstance);
static void c13_b_eml_warning(SFc13_modelo_FK_simul_coleta_dadosInstanceStruct
  *chartInstance, char_T c13_varargin_2[14]);
static void c13_eml_scalar_eg(SFc13_modelo_FK_simul_coleta_dadosInstanceStruct
  *chartInstance);
...
static uint8_T c13_h_emlrt_marshallIn
  (SFc13_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance, const
   mxArray *c13_b_is_active_c13_modelo_FK_simul_coleta_dados, const char_T
   *c13_identifier);
  ...
  (SFc13_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance)
{
  ...
  chartInstance->c13_is_active_c13_modelo_FK_simul_coleta_dados = 0U;
}
  ...
  (SFc13_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance)
{
  ...
  c13_hoistedGlobal =
    chartInstance->c13_is_active_c13_modelo_FK_simul_coleta_dados;
   ...
   mxArray *c13_st)
{
  ...
  chartInstance->c13_is_active_c13_modelo_FK_simul_coleta_dados =
    ...
    "is_active_c13_modelo_FK_simul_coleta_dados");
  sf_mex_destroy(&c13_u);
  c13_update_debugger_state_c13_modelo_FK_simul_coleta_dados(chartInstance);
  ...
  (SFc13_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance)
{
  ...
  chartInstance->c13_sfEvent = CALL_EVENT;
  c13_chartstep_c13_modelo_FK_simul_coleta_dados(chartInstance);
  ...
  *c13_inData)
{
  ...
  const mxArray *c13_y = NULL;
  SFc13_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance;
  chartInstance = (SFc13_modelo_FK_simul_coleta_dadosInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c13_modelo_FK_simul_coleta_dados_get_eml_resolved_functions_info(void)
{
   ...
   *c13_identifier)
{
  ...
  c13_y = c13_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c13_b_is_active_c13_modelo_FK_simul_coleta_dados), &c13_thisId);
  sf_mex_destroy(&c13_b_is_active_c13_modelo_FK_simul_coleta_dados);
  return c13_y;
}
...
void sf_c13_modelo_FK_simul_coleta_dados_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c13_modelo_FK_simul_coleta_dados_get_autoinheritance_info(void)
{
...
mxArray *sf_c13_modelo_FK_simul_coleta_dados_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c13_modelo_FK_simul_coleta_dados
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"w_recuperado\",},{M[8],M[0],T\"is_active_c13_modelo_FK_simul_coleta_dados\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c13_modelo_FK_simul_coleta_dados_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c13_modelo_FK_simul_coleta_dados(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc13_modelo_FK_simul_coleta_dadosInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c13_modelo_FK_simul_coleta_dados
    ((SFc13_modelo_FK_simul_coleta_dadosInstanceStruct*) chartInstanceVar);
  initialize_c13_modelo_FK_simul_coleta_dados
    ((SFc13_modelo_FK_simul_coleta_dadosInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c13_modelo_FK_simul_coleta_dados(void
  *chartInstanceVar)
{
  enable_c13_modelo_FK_simul_coleta_dados
    ((SFc13_modelo_FK_simul_coleta_dadosInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c13_modelo_FK_simul_coleta_dados(void
  *chartInstanceVar)
{
  disable_c13_modelo_FK_simul_coleta_dados
    ((SFc13_modelo_FK_simul_coleta_dadosInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c13_modelo_FK_simul_coleta_dados(void
  *chartInstanceVar)
{
  sf_c13_modelo_FK_simul_coleta_dados
    ((SFc13_modelo_FK_simul_coleta_dadosInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c13_modelo_FK_simul_coleta_dados
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c13_modelo_FK_simul_coleta_dados
    ((SFc13_modelo_FK_simul_coleta_dadosInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c13_modelo_FK_simul_coleta_dados();/* state var info */
...
extern void sf_internal_set_sim_state_c13_modelo_FK_simul_coleta_dados(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c13_modelo_FK_simul_coleta_dados
    ((SFc13_modelo_FK_simul_coleta_dadosInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c13_modelo_FK_simul_coleta_dados
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c13_modelo_FK_simul_coleta_dados(S);
}

static void sf_opaque_set_sim_state_c13_modelo_FK_simul_coleta_dados(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c13_modelo_FK_simul_coleta_dados(S, st);
}

static void sf_opaque_terminate_c13_modelo_FK_simul_coleta_dados(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc13_modelo_FK_simul_coleta_dadosInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c13_modelo_FK_simul_coleta_dados
      ((SFc13_modelo_FK_simul_coleta_dadosInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc13_modelo_FK_simul_coleta_dados
    ((SFc13_modelo_FK_simul_coleta_dadosInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c13_modelo_FK_simul_coleta_dados(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c13_modelo_FK_simul_coleta_dados
      ((SFc13_modelo_FK_simul_coleta_dadosInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c13_modelo_FK_simul_coleta_dados(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c13_modelo_FK_simul_coleta_dados(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c13_modelo_FK_simul_coleta_dados(SimStruct *S)
{
  SFc13_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance;
  chartInstance = (SFc13_modelo_FK_simul_coleta_dadosInstanceStruct *)utMalloc
    (sizeof(SFc13_modelo_FK_simul_coleta_dadosInstanceStruct));
  memset(chartInstance, 0, sizeof
         (SFc13_modelo_FK_simul_coleta_dadosInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c13_modelo_FK_simul_coleta_dados;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c13_modelo_FK_simul_coleta_dados;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c13_modelo_FK_simul_coleta_dados;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c13_modelo_FK_simul_coleta_dados;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c13_modelo_FK_simul_coleta_dados;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c13_modelo_FK_simul_coleta_dados;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c13_modelo_FK_simul_coleta_dados;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c13_modelo_FK_simul_coleta_dados;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c13_modelo_FK_simul_coleta_dados;
  chartInstance->chartInfo.mdlStart = mdlStart_c13_modelo_FK_simul_coleta_dados;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c13_modelo_FK_simul_coleta_dados;
...
void c13_modelo_FK_simul_coleta_dados_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c13_modelo_FK_simul_coleta_dados(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_modelo_FK_simul_coleta_dados(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_modelo_FK_simul_coleta_dados(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_modelo_FK_simul_coleta_dados_method_dispatcher.\n"
