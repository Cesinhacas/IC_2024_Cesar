...
static void initialize_c1_modelo_FK_simul_coleta_dados
  (SFc1_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance);
static void initialize_params_c1_modelo_FK_simul_coleta_dados
  (SFc1_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance);
static void enable_c1_modelo_FK_simul_coleta_dados
  (SFc1_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance);
static void disable_c1_modelo_FK_simul_coleta_dados
  (SFc1_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_modelo_FK_simul_coleta_dados
  (SFc1_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_modelo_FK_simul_coleta_dados
  (SFc1_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance);
static void set_sim_state_c1_modelo_FK_simul_coleta_dados
  (SFc1_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance, const mxArray
   *c1_st);
static void finalize_c1_modelo_FK_simul_coleta_dados
  (SFc1_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance);
static void sf_c1_modelo_FK_simul_coleta_dados
  (SFc1_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance);
static void c1_chartstep_c1_modelo_FK_simul_coleta_dados
  (SFc1_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance);
static void initSimStructsc1_modelo_FK_simul_coleta_dados
  (SFc1_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance);
static void registerMessagesc1_modelo_FK_simul_coleta_dados
  (SFc1_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_modelo_FK_simul_coleta_dadosInstanceStruct *
  chartInstance, const mxArray *c1_dq, const char_T *c1_identifier, real_T c1_y
  [4]);
...
static real_T c1_norm(SFc1_modelo_FK_simul_coleta_dadosInstanceStruct
                      *chartInstance, real_T c1_x[4]);
static void c1_eml_scalar_eg(SFc1_modelo_FK_simul_coleta_dadosInstanceStruct
  *chartInstance);
...
static uint8_T c1_f_emlrt_marshallIn
  (SFc1_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance, const mxArray
   *c1_b_is_active_c1_modelo_FK_simul_coleta_dados, const char_T *c1_identifier);
  ...
  (SFc1_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_modelo_FK_simul_coleta_dados = 0U;
}
  ...
  (SFc1_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_modelo_FK_simul_coleta_dados;
   ...
   *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_modelo_FK_simul_coleta_dados =
    c1_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
    "is_active_c1_modelo_FK_simul_coleta_dados");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_modelo_FK_simul_coleta_dados(chartInstance);
  ...
  (SFc1_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_modelo_FK_simul_coleta_dados(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance;
  chartInstance = (SFc1_modelo_FK_simul_coleta_dadosInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c1_modelo_FK_simul_coleta_dados_get_eml_resolved_functions_info(void)
{
   ...
   *c1_b_is_active_c1_modelo_FK_simul_coleta_dados, const char_T *c1_identifier)
{
  ...
  c1_y = c1_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_modelo_FK_simul_coleta_dados), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_modelo_FK_simul_coleta_dados);
  return c1_y;
}
...
void sf_c1_modelo_FK_simul_coleta_dados_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_modelo_FK_simul_coleta_dados_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_modelo_FK_simul_coleta_dados_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c1_modelo_FK_simul_coleta_dados(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"dq\",},{M[8],M[0],T\"is_active_c1_modelo_FK_simul_coleta_dados\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_modelo_FK_simul_coleta_dados_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c1_modelo_FK_simul_coleta_dados(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_modelo_FK_simul_coleta_dadosInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_modelo_FK_simul_coleta_dados
    ((SFc1_modelo_FK_simul_coleta_dadosInstanceStruct*) chartInstanceVar);
  initialize_c1_modelo_FK_simul_coleta_dados
    ((SFc1_modelo_FK_simul_coleta_dadosInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_modelo_FK_simul_coleta_dados(void
  *chartInstanceVar)
{
  enable_c1_modelo_FK_simul_coleta_dados
    ((SFc1_modelo_FK_simul_coleta_dadosInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_modelo_FK_simul_coleta_dados(void
  *chartInstanceVar)
{
  disable_c1_modelo_FK_simul_coleta_dados
    ((SFc1_modelo_FK_simul_coleta_dadosInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_modelo_FK_simul_coleta_dados(void
  *chartInstanceVar)
{
  sf_c1_modelo_FK_simul_coleta_dados
    ((SFc1_modelo_FK_simul_coleta_dadosInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_modelo_FK_simul_coleta_dados
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_modelo_FK_simul_coleta_dados
    ((SFc1_modelo_FK_simul_coleta_dadosInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_modelo_FK_simul_coleta_dados();/* state var info */
...
extern void sf_internal_set_sim_state_c1_modelo_FK_simul_coleta_dados(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_modelo_FK_simul_coleta_dados
    ((SFc1_modelo_FK_simul_coleta_dadosInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_modelo_FK_simul_coleta_dados
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c1_modelo_FK_simul_coleta_dados(S);
}

static void sf_opaque_set_sim_state_c1_modelo_FK_simul_coleta_dados(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c1_modelo_FK_simul_coleta_dados(S, st);
}

static void sf_opaque_terminate_c1_modelo_FK_simul_coleta_dados(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_modelo_FK_simul_coleta_dadosInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c1_modelo_FK_simul_coleta_dados
      ((SFc1_modelo_FK_simul_coleta_dadosInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_modelo_FK_simul_coleta_dados
    ((SFc1_modelo_FK_simul_coleta_dadosInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_modelo_FK_simul_coleta_dados(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_modelo_FK_simul_coleta_dados
      ((SFc1_modelo_FK_simul_coleta_dadosInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_modelo_FK_simul_coleta_dados(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c1_modelo_FK_simul_coleta_dados(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_modelo_FK_simul_coleta_dados(SimStruct *S)
{
  SFc1_modelo_FK_simul_coleta_dadosInstanceStruct *chartInstance;
  chartInstance = (SFc1_modelo_FK_simul_coleta_dadosInstanceStruct *)utMalloc
    (sizeof(SFc1_modelo_FK_simul_coleta_dadosInstanceStruct));
  memset(chartInstance, 0, sizeof
         (SFc1_modelo_FK_simul_coleta_dadosInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_modelo_FK_simul_coleta_dados;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_modelo_FK_simul_coleta_dados;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_modelo_FK_simul_coleta_dados;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_modelo_FK_simul_coleta_dados;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_modelo_FK_simul_coleta_dados;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_modelo_FK_simul_coleta_dados;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_modelo_FK_simul_coleta_dados;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_modelo_FK_simul_coleta_dados;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_modelo_FK_simul_coleta_dados;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_modelo_FK_simul_coleta_dados;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_modelo_FK_simul_coleta_dados;
...
void c1_modelo_FK_simul_coleta_dados_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_modelo_FK_simul_coleta_dados(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_modelo_FK_simul_coleta_dados(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_modelo_FK_simul_coleta_dados(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_modelo_FK_simul_coleta_dados_method_dispatcher.\n"
