...
static void initialize_c13_modelo_FK_pratico_coleta_dados_v2
  (SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void initialize_params_c13_modelo_FK_pratico_coleta_dados_v2
  (SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void enable_c13_modelo_FK_pratico_coleta_dados_v2
  (SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void disable_c13_modelo_FK_pratico_coleta_dados_v2
  (SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void c13_update_debugger_state_c13_modelo_FK_pratico_coleta_dados_v2
  (SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c13_modelo_FK_pratico_coleta_dados_v2
  (SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void set_sim_state_c13_modelo_FK_pratico_coleta_dados_v2
  (SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance, const
   mxArray *c13_st);
static void finalize_c13_modelo_FK_pratico_coleta_dados_v2
  (SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void sf_c13_modelo_FK_pratico_coleta_dados_v2
  (SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void c13_chartstep_c13_modelo_FK_pratico_coleta_dados_v2
  (SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void initSimStructsc13_modelo_FK_pratico_coleta_dados_v2
  (SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void registerMessagesc13_modelo_FK_pratico_coleta_dados_v2
  (SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
...
static void c13_inv3x3(SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct
  *chartInstance, real_T c13_x[9], real_T c13_y[9]);
static real_T c13_norm(SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct
  *chartInstance, real_T c13_x[9]);
static void c13_eml_warning
  (SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void c13_b_eml_warning
  (SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance, char_T
   c13_varargin_2[14]);
...
static uint8_T c13_h_emlrt_marshallIn
  (SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance, const
   mxArray *c13_b_is_active_c13_modelo_FK_pratico_coleta_dados_v2, const char_T *
   c13_identifier);
  ...
  (SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c13_is_active_c13_modelo_FK_pratico_coleta_dados_v2 = 0U;
}
  ...
  (SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance)
{
  ...
  c13_hoistedGlobal =
    chartInstance->c13_is_active_c13_modelo_FK_pratico_coleta_dados_v2;
   ...
   mxArray *c13_st)
{
  ...
  chartInstance->c13_is_active_c13_modelo_FK_pratico_coleta_dados_v2 =
    ...
    "is_active_c13_modelo_FK_pratico_coleta_dados_v2");
  sf_mex_destroy(&c13_u);
  c13_update_debugger_state_c13_modelo_FK_pratico_coleta_dados_v2(chartInstance);
  ...
  (SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c13_sfEvent = CALL_EVENT;
  c13_chartstep_c13_modelo_FK_pratico_coleta_dados_v2(chartInstance);
  ...
  *c13_inData)
{
  ...
  const mxArray *c13_y = NULL;
  SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance;
  chartInstance = (SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c13_modelo_FK_pratico_coleta_dados_v2_get_eml_resolved_functions_info(void)
{
   ...
   c13_identifier)
{
  ...
  c13_y = c13_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c13_b_is_active_c13_modelo_FK_pratico_coleta_dados_v2), &c13_thisId);
  sf_mex_destroy(&c13_b_is_active_c13_modelo_FK_pratico_coleta_dados_v2);
  return c13_y;
}
...
void sf_c13_modelo_FK_pratico_coleta_dados_v2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c13_modelo_FK_pratico_coleta_dados_v2_get_autoinheritance_info(void)
{
...
mxArray *sf_c13_modelo_FK_pratico_coleta_dados_v2_third_party_uses_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c13_modelo_FK_pratico_coleta_dados_v2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"w_recuperado\",},{M[8],M[0],T\"is_active_c13_modelo_FK_pratico_coleta_dados_v2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c13_modelo_FK_pratico_coleta_dados_v2_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c13_modelo_FK_pratico_coleta_dados_v2(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c13_modelo_FK_pratico_coleta_dados_v2
    ((SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct*) chartInstanceVar);
  initialize_c13_modelo_FK_pratico_coleta_dados_v2
    ((SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c13_modelo_FK_pratico_coleta_dados_v2(void
  *chartInstanceVar)
{
  enable_c13_modelo_FK_pratico_coleta_dados_v2
    ((SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c13_modelo_FK_pratico_coleta_dados_v2(void
  *chartInstanceVar)
{
  disable_c13_modelo_FK_pratico_coleta_dados_v2
    ((SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c13_modelo_FK_pratico_coleta_dados_v2(void
  *chartInstanceVar)
{
  sf_c13_modelo_FK_pratico_coleta_dados_v2
    ((SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c13_modelo_FK_pratico_coleta_dados_v2(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c13_modelo_FK_pratico_coleta_dados_v2
    ((SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c13_modelo_FK_pratico_coleta_dados_v2();/* state var info */
...
extern void sf_internal_set_sim_state_c13_modelo_FK_pratico_coleta_dados_v2
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c13_modelo_FK_pratico_coleta_dados_v2
    ((SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c13_modelo_FK_pratico_coleta_dados_v2(SimStruct* S)
{
  return sf_internal_get_sim_state_c13_modelo_FK_pratico_coleta_dados_v2(S);
}

static void sf_opaque_set_sim_state_c13_modelo_FK_pratico_coleta_dados_v2
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c13_modelo_FK_pratico_coleta_dados_v2(S, st);
}

static void sf_opaque_terminate_c13_modelo_FK_pratico_coleta_dados_v2(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c13_modelo_FK_pratico_coleta_dados_v2
      ((SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc13_modelo_FK_pratico_coleta_dados_v2
    ((SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c13_modelo_FK_pratico_coleta_dados_v2(SimStruct
  *S)
{
  int i;
...
static void mdlSetWorkWidths_c13_modelo_FK_pratico_coleta_dados_v2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c13_modelo_FK_pratico_coleta_dados_v2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c13_modelo_FK_pratico_coleta_dados_v2(SimStruct *S)
{
  SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance;
  chartInstance = (SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct *)
    utMalloc(sizeof(SFc13_modelo_FK_pratico_coleta_dados_v2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c13_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c13_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c13_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c13_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c13_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c13_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c13_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c13_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c13_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c13_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c13_modelo_FK_pratico_coleta_dados_v2;
...
void c13_modelo_FK_pratico_coleta_dados_v2_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c13_modelo_FK_pratico_coleta_dados_v2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_modelo_FK_pratico_coleta_dados_v2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_modelo_FK_pratico_coleta_dados_v2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_modelo_FK_pratico_coleta_dados_v2_method_dispatcher.\n"
