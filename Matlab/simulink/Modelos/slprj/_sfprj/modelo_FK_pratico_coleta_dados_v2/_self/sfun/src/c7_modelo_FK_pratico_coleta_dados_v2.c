...
static void initialize_c7_modelo_FK_pratico_coleta_dados_v2
  (SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void initialize_params_c7_modelo_FK_pratico_coleta_dados_v2
  (SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void enable_c7_modelo_FK_pratico_coleta_dados_v2
  (SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void disable_c7_modelo_FK_pratico_coleta_dados_v2
  (SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void c7_update_debugger_state_c7_modelo_FK_pratico_coleta_dados_v2
  (SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_modelo_FK_pratico_coleta_dados_v2
  (SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void set_sim_state_c7_modelo_FK_pratico_coleta_dados_v2
  (SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance, const
   mxArray *c7_st);
static void finalize_c7_modelo_FK_pratico_coleta_dados_v2
  (SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void sf_c7_modelo_FK_pratico_coleta_dados_v2
  (SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void initSimStructsc7_modelo_FK_pratico_coleta_dados_v2
  (SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void registerMessagesc7_modelo_FK_pratico_coleta_dados_v2
  (SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
...
static uint8_T c7_h_emlrt_marshallIn
  (SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance, const
   mxArray *c7_b_is_active_c7_modelo_FK_pratico_coleta_dados_v2, const char_T
   *c7_identifier);
  ...
  (SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_modelo_FK_pratico_coleta_dados_v2 = 0U;
}
  ...
  (SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance)
{
  ...
  c7_b_hoistedGlobal =
    chartInstance->c7_is_active_c7_modelo_FK_pratico_coleta_dados_v2;
   ...
   mxArray *c7_st)
{
  ...
  *c7_Timer_TETRA = c7_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c7_is_active_c7_modelo_FK_pratico_coleta_dados_v2 =
    ...
    "is_active_c7_modelo_FK_pratico_coleta_dados_v2");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_modelo_FK_pratico_coleta_dados_v2(chartInstance);
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  const mxArray *c7_y = NULL;
  SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance;
  chartInstance = (SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c7_modelo_FK_pratico_coleta_dados_v2_get_eml_resolved_functions_info(void)
{
   ...
   *c7_identifier)
{
  ...
  c7_y = c7_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c7_b_is_active_c7_modelo_FK_pratico_coleta_dados_v2), &c7_thisId);
  sf_mex_destroy(&c7_b_is_active_c7_modelo_FK_pratico_coleta_dados_v2);
  return c7_y;
}
...
void sf_c7_modelo_FK_pratico_coleta_dados_v2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c7_modelo_FK_pratico_coleta_dados_v2_get_autoinheritance_info(void)
{
...
mxArray *sf_c7_modelo_FK_pratico_coleta_dados_v2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c7_modelo_FK_pratico_coleta_dados_v2
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[18],T\"Timer_TETRA\",},{M[1],M[16],T\"acc_TETRA\",},{M[1],M[17],T\"gyro_TETRA\",},{M[1],M[14],T\"mag_TETRA\",},{M[8],M[0],T\"is_active_c7_modelo_FK_pratico_coleta_dados_v2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_modelo_FK_pratico_coleta_dados_v2_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c7_modelo_FK_pratico_coleta_dados_v2(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c7_modelo_FK_pratico_coleta_dados_v2
    ((SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct*) chartInstanceVar);
  initialize_c7_modelo_FK_pratico_coleta_dados_v2
    ((SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c7_modelo_FK_pratico_coleta_dados_v2(void
  *chartInstanceVar)
{
  enable_c7_modelo_FK_pratico_coleta_dados_v2
    ((SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c7_modelo_FK_pratico_coleta_dados_v2(void
  *chartInstanceVar)
{
  disable_c7_modelo_FK_pratico_coleta_dados_v2
    ((SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c7_modelo_FK_pratico_coleta_dados_v2(void
  *chartInstanceVar)
{
  sf_c7_modelo_FK_pratico_coleta_dados_v2
    ((SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c7_modelo_FK_pratico_coleta_dados_v2(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c7_modelo_FK_pratico_coleta_dados_v2
    ((SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c7_modelo_FK_pratico_coleta_dados_v2();/* state var info */
...
extern void sf_internal_set_sim_state_c7_modelo_FK_pratico_coleta_dados_v2
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c7_modelo_FK_pratico_coleta_dados_v2
    ((SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c7_modelo_FK_pratico_coleta_dados_v2(SimStruct* S)
{
  return sf_internal_get_sim_state_c7_modelo_FK_pratico_coleta_dados_v2(S);
}

static void sf_opaque_set_sim_state_c7_modelo_FK_pratico_coleta_dados_v2
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c7_modelo_FK_pratico_coleta_dados_v2(S, st);
}

static void sf_opaque_terminate_c7_modelo_FK_pratico_coleta_dados_v2(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c7_modelo_FK_pratico_coleta_dados_v2
      ((SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc7_modelo_FK_pratico_coleta_dados_v2
    ((SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_modelo_FK_pratico_coleta_dados_v2(SimStruct *
  S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c7_modelo_FK_pratico_coleta_dados_v2
      ((SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct*)(((ChartInfoStruct
          *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c7_modelo_FK_pratico_coleta_dados_v2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c7_modelo_FK_pratico_coleta_dados_v2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_modelo_FK_pratico_coleta_dados_v2(SimStruct *S)
{
  SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance;
  chartInstance = (SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct *)
    utMalloc(sizeof(SFc7_modelo_FK_pratico_coleta_dados_v2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c7_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c7_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c7_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c7_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c7_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c7_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c7_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c7_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c7_modelo_FK_pratico_coleta_dados_v2;
...
void c7_modelo_FK_pratico_coleta_dados_v2_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_modelo_FK_pratico_coleta_dados_v2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_modelo_FK_pratico_coleta_dados_v2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_modelo_FK_pratico_coleta_dados_v2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_modelo_FK_pratico_coleta_dados_v2_method_dispatcher.\n"
