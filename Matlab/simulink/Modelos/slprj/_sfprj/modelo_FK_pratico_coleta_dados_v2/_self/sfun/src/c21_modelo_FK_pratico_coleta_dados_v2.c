...
static void initialize_c21_modelo_FK_pratico_coleta_dados_v2
  (SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void initialize_params_c21_modelo_FK_pratico_coleta_dados_v2
  (SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void enable_c21_modelo_FK_pratico_coleta_dados_v2
  (SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void disable_c21_modelo_FK_pratico_coleta_dados_v2
  (SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void c21_update_debugger_state_c21_modelo_FK_pratico_coleta_dados_v2
  (SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c21_modelo_FK_pratico_coleta_dados_v2
  (SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void set_sim_state_c21_modelo_FK_pratico_coleta_dados_v2
  (SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance, const
   mxArray *c21_st);
static void finalize_c21_modelo_FK_pratico_coleta_dados_v2
  (SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void sf_c21_modelo_FK_pratico_coleta_dados_v2
  (SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void c21_chartstep_c21_modelo_FK_pratico_coleta_dados_v2
  (SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void initSimStructsc21_modelo_FK_pratico_coleta_dados_v2
  (SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void registerMessagesc21_modelo_FK_pratico_coleta_dados_v2
  (SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
...
static void c21_eye(SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct
                    *chartInstance, real_T c21_I[9]);
static void c21_eml_scalar_eg
  (SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static real_T c21_mod(SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct
                      *chartInstance, real_T c21_x, real_T c21_y);
static void c21_eps(SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct
                    *chartInstance);
static void c21_b_eml_scalar_eg
  (SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void c21_c_eml_scalar_eg
  (SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void c21_b_eye(SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct
                      *chartInstance, real_T c21_I[16]);
static void c21_inv(SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct
                    *chartInstance, real_T c21_x[9], real_T c21_y[9]);
static void c21_inv3x3(SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct
  *chartInstance, real_T c21_x[9], real_T c21_y[9]);
static real_T c21_norm(SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct
  *chartInstance, real_T c21_x[9]);
static void c21_eml_warning
  (SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static void c21_b_eml_warning
  (SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance, char_T
   c21_varargin_2[14]);
...
static void c21_h_eml_scalar_eg
  (SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance);
static real_T c21_dot(SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct
...
static uint8_T c21_t_emlrt_marshallIn
  (SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance, const
   mxArray *c21_b_is_active_c21_modelo_FK_pratico_coleta_dados_v2, const char_T *
   c21_identifier);
  ...
  (SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c21_is_active_c21_modelo_FK_pratico_coleta_dados_v2 = 0U;
}
  ...
  (SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance)
{
  ...
  c21_hoistedGlobal =
    chartInstance->c21_is_active_c21_modelo_FK_pratico_coleta_dados_v2;
   ...
   mxArray *c21_st)
{
  ...
  chartInstance->c21_is_active_c21_modelo_FK_pratico_coleta_dados_v2 =
    ...
    "is_active_c21_modelo_FK_pratico_coleta_dados_v2");
  sf_mex_destroy(&c21_u);
  c21_update_debugger_state_c21_modelo_FK_pratico_coleta_dados_v2(chartInstance);
  ...
  (SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c21_sfEvent = CALL_EVENT;
  c21_chartstep_c21_modelo_FK_pratico_coleta_dados_v2(chartInstance);
  ...
  *c21_inData)
{
  ...
  const mxArray *c21_y = NULL;
  SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance;
  chartInstance = (SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c21_modelo_FK_pratico_coleta_dados_v2_get_eml_resolved_functions_info(void)
{
   ...
   c21_identifier)
{
  ...
  c21_y = c21_u_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c21_b_is_active_c21_modelo_FK_pratico_coleta_dados_v2), &c21_thisId);
  sf_mex_destroy(&c21_b_is_active_c21_modelo_FK_pratico_coleta_dados_v2);
  return c21_y;
}
...
void sf_c21_modelo_FK_pratico_coleta_dados_v2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c21_modelo_FK_pratico_coleta_dados_v2_get_autoinheritance_info(void)
{
...
mxArray *sf_c21_modelo_FK_pratico_coleta_dados_v2_third_party_uses_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c21_modelo_FK_pratico_coleta_dados_v2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[10],T\"PT_est\",},{M[1],M[9],T\"P_est\",},{M[1],M[5],T\"x_est\",},{M[8],M[0],T\"is_active_c21_modelo_FK_pratico_coleta_dados_v2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c21_modelo_FK_pratico_coleta_dados_v2_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c21_modelo_FK_pratico_coleta_dados_v2(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c21_modelo_FK_pratico_coleta_dados_v2
    ((SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct*) chartInstanceVar);
  initialize_c21_modelo_FK_pratico_coleta_dados_v2
    ((SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c21_modelo_FK_pratico_coleta_dados_v2(void
  *chartInstanceVar)
{
  enable_c21_modelo_FK_pratico_coleta_dados_v2
    ((SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c21_modelo_FK_pratico_coleta_dados_v2(void
  *chartInstanceVar)
{
  disable_c21_modelo_FK_pratico_coleta_dados_v2
    ((SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c21_modelo_FK_pratico_coleta_dados_v2(void
  *chartInstanceVar)
{
  sf_c21_modelo_FK_pratico_coleta_dados_v2
    ((SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c21_modelo_FK_pratico_coleta_dados_v2(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c21_modelo_FK_pratico_coleta_dados_v2
    ((SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c21_modelo_FK_pratico_coleta_dados_v2();/* state var info */
...
extern void sf_internal_set_sim_state_c21_modelo_FK_pratico_coleta_dados_v2
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c21_modelo_FK_pratico_coleta_dados_v2
    ((SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c21_modelo_FK_pratico_coleta_dados_v2(SimStruct* S)
{
  return sf_internal_get_sim_state_c21_modelo_FK_pratico_coleta_dados_v2(S);
}

static void sf_opaque_set_sim_state_c21_modelo_FK_pratico_coleta_dados_v2
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c21_modelo_FK_pratico_coleta_dados_v2(S, st);
}

static void sf_opaque_terminate_c21_modelo_FK_pratico_coleta_dados_v2(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c21_modelo_FK_pratico_coleta_dados_v2
      ((SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc21_modelo_FK_pratico_coleta_dados_v2
    ((SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c21_modelo_FK_pratico_coleta_dados_v2(SimStruct
  *S)
{
  int i;
...
static void mdlSetWorkWidths_c21_modelo_FK_pratico_coleta_dados_v2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c21_modelo_FK_pratico_coleta_dados_v2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c21_modelo_FK_pratico_coleta_dados_v2(SimStruct *S)
{
  SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *chartInstance;
  chartInstance = (SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct *)
    utMalloc(sizeof(SFc21_modelo_FK_pratico_coleta_dados_v2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c21_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c21_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c21_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c21_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c21_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c21_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c21_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c21_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c21_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c21_modelo_FK_pratico_coleta_dados_v2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c21_modelo_FK_pratico_coleta_dados_v2;
...
void c21_modelo_FK_pratico_coleta_dados_v2_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c21_modelo_FK_pratico_coleta_dados_v2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c21_modelo_FK_pratico_coleta_dados_v2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c21_modelo_FK_pratico_coleta_dados_v2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c21_modelo_FK_pratico_coleta_dados_v2_method_dispatcher.\n"
