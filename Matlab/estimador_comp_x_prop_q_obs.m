...
estados_est_c = readmatrix("estados_estimados_c_INTEGRADO.csv");
covT_est_c = readmatrix("covT_triad_est_c_INTEGRADO.csv");
cov_est_c = readmatrix("cov_triad_est_c_INTEGRADO.csv");
cd ..\
