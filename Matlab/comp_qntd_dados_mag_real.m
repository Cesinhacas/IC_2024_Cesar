...
cd Dados_reais\
data = readmatrix('dados_mag_25_08_half.csv');
...
data = readmatrix('dados_mag_25_08_half2.csv');
...
data = readmatrix('magnetometro_data_20250825_114625.csv');
...
%data = readmatrix('magnetometro_data_20250813_145206.csv');
