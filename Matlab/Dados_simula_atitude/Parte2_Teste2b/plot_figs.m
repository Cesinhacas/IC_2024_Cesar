...
for i=1:1:1201
    q = q_est_c_sr(i,:);
    if q(1) < 0.0 || i==116 || i==404 || i==578 || i==579 || i==755 || i==1038
        q_est_c_sr(i,:) = -q_est_c_sr(i,:);
    end
    q = q_prop_c_sr(i,:);
    if q(1) < 0.0 || i==578 || i==755 || i==1038 || i==280 || i==900
    ...
    if i==281 || i==282 || i==405 || i==578 || i == 579 || i==755 || i==756 || i==757 || i==758 || i==759 || i==901 || i ==902 || i==1038
        q_prop_sr(i,:) = -q_prop_sr(i,:);
        q_est_sr(i,:) = - q_est_sr(i,:);
    end
    
    if i==117 || i==118 || i==281 || i==282 || i==405 || i==578 || i==755 || i==756 || i==757 || i==758 || i==901 || i==1038
