...
print("Medidas acelerômetro:", dados_accel[0][0], dados_accel[1][0], dados_accel[2][0])
print("Medidas magnetômetro:", dados_mag[0][0], dados_mag[1][0], dados_mag[2][0])
quaternion = pd.DataFrame(quaternion)
quaternion.to_csv('/mnt/c/Users/labt5/OneDrive/Desktop/Cesar/IC_2024_Cesar/Matlab/Dados_simula_atitude/Parte2_Teste1a/quaternion_c.csv', header=False, index=False)

estados_propagados = pd.DataFrame(estados_propagados)
estados_propagados.to_csv('/mnt/c/Users/labt5/OneDrive/Desktop/Cesar/IC_2024_Cesar/Matlab/Dados_simula_atitude/Parte2_Teste1a/estados_propagados_c.csv', header=False, index=False)

estados_estimados = pd.DataFrame(estados_estimados)
estados_estimados.to_csv('/mnt/c/Users/labt5/OneDrive/Desktop/Cesar/IC_2024_Cesar/Matlab/Dados_simula_atitude/Parte2_Teste1a/estados_estimados_c.csv', header=False, index=False)
