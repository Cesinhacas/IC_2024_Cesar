...
int NLLS_64(double *mx, double *my, double *mz, double *p)
{
    int passo = 0, loop = 1;
...
void ETS_64(double *mx, double *my, double *mz, double *p)
{
    //Cria a matriz H
    ...
    double X1_2 = 0, X2_2 = 0, X3_2 = 0, X4_2 = 0, X5_2 = 0, X6_2 = 0, X7_2 = 0, X8_2 = 0;
    for(int i=0; i < tam; i++)
    {
        mat_H[0][i] = mx[i]*mx[i];
        mat_H[1][i] = mx[i]*my[i];
