...
double quat_res[4][tam] = {0}, x_est_res[7][tam] = {0}, x_prop_res[7][tam] = {0}, time_res[tam] = {0};
...
int main(void)
{
  ...
  while (1)
  {
	...
	while(i < tam)
	{
		...
		FK_estimador(x_prop, PT_prop, q, R, i, x_est, PT_est, P_est);
